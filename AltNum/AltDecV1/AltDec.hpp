...
AltNum_EnableTrigExpressions = (Not Implemented)
...
AltNum_EnableIFractional = Auto toggled if AltNum_EnableAlternativeRepFractionals and AltNum_EnableIRep enabled without AltNum_EnableDecimaledIFractionals toggled
...
#endif
#if !defined(AltNum_EnableIFractional) &&defined(AltNum_EnableIRep)&&!defined(AltNum_EnableDecimaledIFractionals)&&defined(AltNum_EnableAlternativeRepFractionals)
