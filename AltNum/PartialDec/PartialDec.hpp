...
public:
    ...
    #pragma region ConvertFromOtherTypes
        ...
        /// </summary>
        /// <param name="Value">The value.</param>
        PartialDec(const long double& Value)
        {
...
public:
        ...
        /// </summary>
        /// <param name="rValue.">The right side Value</param>
        PartialDec& BasicMultOp(const PartialDec& rValue)
		{
            if (DecimalHalf == 0)
            {
                if (IntHalf == 1)
            ...
            else if (IntHalf == 0)
            {
                ...
                else
                {
                    ...
                    {
                        UInt128 OverflowVal = SRep / PartialDec::DecimalOverflowX;
            ...
            else
            {
                ...
                {
                    UInt128 SRep = PartialDec::DecimalOverflowX * IntHalf + DecimalHalf;
                    SRep *= rValue.IntHalf;
                    if (SRep >= PartialDec::DecimalOverflowX)
                    {
                        UInt128 OverflowVal = SRep / PartialDec::DecimalOverflowX;
                    ...
                    else
                    {
                        ...
                        IntHalf = SelfIsNegative ? PartialDec::NegativeRep : 0;
                    }
				    return *this;
                }
                ...
                else
                {
                    ...
                    UInt128 SRep = IntHalf == 0 ? DecimalHalf : PartialDec::DecimalOverflowX * IntHalf + DecimalHalf;
                    ...
                    UInt128 IntHalf = IntegerRep / PartialDec::DecimalOverflow;
                    IntegerRep -= PartialDec::DecimalOverflowX * IntHalf;
