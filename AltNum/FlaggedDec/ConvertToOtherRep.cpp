...
inline void BlazesRusCode::FlaggedDec::ConvertPiPowerToNum()
{
	int powerExponent = -ExtraRep;
	ExtraRep = 0;
	FlaggedDec PiSide = PiNum;
	PiSide.IntPowOp(powerExponent);
	BasicMultOp(PiSide);
}

inline FlaggedDec BlazesRusCode::FlaggedDec::PiPowerNum(int powerExponent)
{
	ExtraRep = 0;
	FlaggedDec PiSide = PiNum;
	PiSide.IntPowOp(powerExponent);
...
inline void BlazesRusCode::FlaggedDec::ConvertPiPowerToPiRep()
{
	int powerExponent = -ExtraRep;
	if (powerExponent == 0)
		ExtraRep = 0;//Pi^0 = 1
...
inline void BlazesRusCode::FlaggedDec::ConvertEByDivToNumByDiv()
{
