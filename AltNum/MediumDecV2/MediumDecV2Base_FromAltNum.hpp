...
/*---Accuracy Tests(with MediumDecV2Base based settings):
...
protected:
        ...
        /// If DecimalHalf is negative and ExtraRep is Positive, then MediumDecV2Base represents mixed fraction of -2147483648 to 2147483647 + (DecimalHalf*-1)/ExtraRep
        /// If ExtraRep is zero and DecimalHalf is positive, then MediumDecV2Base represents +- 2147483647.999999999
        ///-----------------------------------------------
        /// If ExtraRep is negative, it acts as representation type similar to MediumDecV2Base:
		/// If ExtraRep is between 0 and , it acts as representation type similar to MediumDecV2Base:
        /// If DecimalHalf is positive and ExtraRep is -2147483648 and AltNum_EnablePiRep is enabled, then MediumDecV2Base represents +- 2147483647.999999999 * Pi
        /// </summary>
        signed int ExtraRep;
        ...
        MediumDecV2Base(const MirroredInt& intVal = MirroredInt::Zero, const signed int& decVal = 0, const signed int& extraVal = 0)
        {
        ...
        void SetVal(const MediumDecV2Base& Value)
        {
	...
	#pragma region PiNum Setters
        ...
        void SetPiVal(const MediumDecV2Base& Value)
        {
            if(ExtraRep==0)
            {
                IntValue = Value.IntValue; DecimalHalf = Value.DecimalHalf;
	...
	#pragma region ENum Setters
        ...
        void SetEVal(const MediumDecV2Base& Value)
        {
            if(ExtraRep==0)
            {
                IntValue = Value.IntValue; DecimalHalf = Value.DecimalHalf;
    ...
    #pragma region Fractional Setters
        ...
        //Set value for NumByDiv
        void SetFractionalVal(MediumDecV2Base Value, int Divisor)
        {
            IntValue = Value.IntValue; DecimalHalf = Value.DecimalHalf;
            ExtraRep = Divisor;
        }
    ...
    protected:
	#if defined(AltNum_EnableNaN)
        static MediumDecV2Base NaNValue()
        {
            MediumDecV2Base NewSelf = MediumDecV2Base(0, NaNRep);
            return NewSelf;
        }
		
        static MediumDecV2Base UndefinedValue()
        {
            MediumDecV2Base NewSelf = MediumDecV2Base(0, UndefinedRep);
            return NewSelf;
        }
	#endif

	#if defined(AltNum_EnableInfinityRep)
        static MediumDecV2Base InfinityValue()
        {
            MediumDecV2Base NewSelf = MediumDecV2Base(1, InfinityRep);
            return NewSelf;
        }
        
        static MediumDecV2Base NegativeInfinityValue()
        {
            MediumDecV2Base NewSelf = MediumDecV2Base(-1, InfinityRep);
            return NewSelf;
        }
	...
	#if defined(AltNum_EnableApproachingValues)
        static MediumDecV2Base ApproachingZeroValue()
        {
            MediumDecV2Base NewSelf = MediumDecV2Base(0, ApproachingBottomRep);
            return NewSelf;
        }
		
        static MediumDecV2Base ApproachingOneFromLeftValue()
        {
            MediumDecV2Base NewSelf = MediumDecV2Base(0, ApproachingTopRep);
            return NewSelf;
        }
		
        static MediumDecV2Base ApproachingOneFromRightValue()
        {
            MediumDecV2Base NewSelf = MediumDecV2Base(1, ApproachingBottomRep);
            return NewSelf;
        }

        static MediumDecV2Base NegativeApproachingZeroValue()
        {
            MediumDecV2Base NewSelf = MediumDecV2Base(NegativeRep, ApproachingBottomRep);
            return NewSelf;
        }
	#endif
        /// <summary>
        ...
        static MediumDecV2Base PiValue()
        {
#if defined(AltNum_EnableERep)
            return MediumDecV2Base(1, PiRep);
#else
            return MediumDecV2Base(3, 141592654);
#endif
        }
        ...
        static MediumDecV2Base HundredMilPiNumVal()
        {
            return MediumDecV2Base(314159265, 358979324);
        }

        //10,000,000xPi(Rounded to 9th decimal digit)
        static MediumDecV2Base TenMilPiNumVal()
        {
            return MediumDecV2Base(31415926, 535897932);
        }

        //1,000,000xPi(Rounded to 9th decimal digit)
        static MediumDecV2Base OneMilPiNumVal()
        {
            return MediumDecV2Base(3141592, 653589793);
        }

        //10xPi(Rounded to 9th decimal digit)
        static MediumDecV2Base TenPiNumVal()
        {
        ...
        static MediumDecV2Base EValue()
        {
#if defined(AltNum_EnableERep)
            return MediumDecV2Base(1, ERep);
#else
            return MediumDecV2Base(2, 718281828);
#endif
        }
        ...
        {
            MediumDecV2Base NewSelf = MediumDecV2Base(1);
            return NewSelf;
        }
        ...
        {
            MediumDecV2Base NewSelf = MediumDecV2Base(2);
            return NewSelf;
        }
        ...
        {
            MediumDecV2Base NewSelf = MediumDecV2Base(0, 500000000);
            return NewSelf;
        }

        static MediumDecV2Base JustAboveZeroValue()
        {
            MediumDecV2Base NewSelf = MediumDecV2Base(0, 1);
            return NewSelf;
        }

        static MediumDecV2Base OneMillionthValue()
        {
            MediumDecV2Base NewSelf = MediumDecV2Base(0, 1000);
            return NewSelf;
        }

        static MediumDecV2Base FiveThousandthValue()
        {
            MediumDecV2Base NewSelf = MediumDecV2Base(0, 5000000);
            return NewSelf;
        }

        static MediumDecV2Base FiveMillionthValue()
        {
            MediumDecV2Base NewSelf = MediumDecV2Base(0, 5000);
            return NewSelf;
        }

        static MediumDecV2Base TenMillionthValue()
        {
            MediumDecV2Base NewSelf = MediumDecV2Base(0, 100);
            return NewSelf;
        }

        static MediumDecV2Base OneHundredMillionthValue()
        {
            MediumDecV2Base NewSelf = MediumDecV2Base(0, 10);
            return NewSelf;
        }

        static MediumDecV2Base FiveBillionthValue()
        {
            MediumDecV2Base NewSelf = MediumDecV2Base(0, 5);
            return NewSelf;
        }
        ...
        static MediumDecV2Base LN10MultValue()
        {
            return MediumDecV2Base(0, 434294482);
        }

        static MediumDecV2Base HalfLN10MultValue()
        {
            return MediumDecV2Base(0, 868588964);
        }
        
    #if defined(AltNum_EnableNil)
        static MediumDecV2Base NilValue()
        {
            return MediumDecV2Base(NilRep, NilRep);
        }
    #endif

        static MediumDecV2Base MinimumValue()
        {
            return MediumDecV2Base(2147483647, 999999999);
        }
...
public:
...
#if defined(AltNum_EnableInfinityRep)
        static MediumDecV2Base Infinity;
        static MediumDecV2Base NegativeInfinity;
        static MediumDecV2Base ApproachingZero;
#endif
        ...
        /// </summary>
        static MediumDecV2Base LN10Mult;

        /// <summary>
        /// (1 / Ln10)*2 (Ln10 operation as division as recommended by https://helloacm.com/fast-integer-log10/ for speed optimization)
        /// </summary>
        static MediumDecV2Base HalfLN10Mult;

    #if defined(AltNum_EnableNil)
        /// <summary>
        /// Nil Value as proposed by https://docs.google.com/document/d/19n-E8Mu-0MWCcNt0pQnFi2Osq-qdMDW6aCBweMKiEb4/edit
        /// </summary>
        static MediumDecV2Base Nil;
    #endif
	
#if defined(AltNum_EnableApproachingValues)
        static MediumDecV2Base ApproachingRightRealValue(int IntValue=0)
        {
            return MediumDecV2Base(IntValue, 999999999);
        }

        static MediumDecV2Base ApproachingLeftRealValue(int IntValue=0)
        {
            return MediumDecV2Base(IntValue, 1);
        }

        static MediumDecV2Base LeftAlmostPointFiveRealValue(int IntValue=0)
        {
            return MediumDecV2Base(IntValue, 499999999);
        }

        static MediumDecV2Base RightAlmostPointFiveRealValue(int IntValue=0)
        {
            return MediumDecV2Base(IntValue, 500000001);
        }
#endif
...
public:
    ...
    #if defined(AltNum_EnableMediumDecBasedSetValues)
        MediumDecV2Base(MediumDec Value)
        {
            this->SetVal(Value);
        }
    #endif
    ...
    #pragma region MirroredIntBased Operations
		...
		bool IntPartEqualTo(MediumDecV2Base& RValue)
		{
		...
		static bool IntPartLessThanOp(MediumDecV2Base& LValue, MediumDecV2Base& RValue) 
        {	return LValue.IntHalfLessThanOrEqualOp(RValue.IntValue); }
        ...
        /// <param name="RValue">The right side value</param>
        /// <returns>bool</returns>
		static bool IntPartHalfLessThanOrEqual(MediumDecV2Base LValue, MediumDecV2Base RValue) 
        {	return LValue.IntHalfLessThanOrEqualOp(RValue.IntValue); }

		static bool IntPartLessThanOrEqualOp(MediumDecV2Base& LValue, MediumDecV2Base& RValue) 
        {	return LValue.IntHalfLessThanOrEqualOp(RValue.IntValue); }
        ...
        /// <param name="RValue">The right side value</param>
        /// <returns>bool</returns>
		static bool IntPartGreaterThan(MediumDecV2Base LValue, MediumDecV2Base RValue) 
        {	return LValue.IntHalfGreaterThanOp(RValue.IntValue); }

		static bool IntPartGreaterThanOp(MediumDecV2Base& LValue, MediumDecV2Base& RValue) 
        {	return LValue.IntHalfGreaterThanOp(RValue.IntValue); }
        ...
        /// <param name="RValue">The right side value</param>
        /// <returns>bool</returns>
		static bool IntPartGreaterThanOrEqual(MediumDecV2Base LValue, MediumDecV2Base RValue) 
        {	return LValue.IntHalfGreaterThanOrEqualOp(RValue.IntValue); }

		static bool IntPartGreaterThanOrEqualOp(MediumDecV2Base& LValue, MediumDecV2Base& RValue) 
        {	return LValue.IntHalfGreaterThanOrEqualOp(RValue.IntValue); }
    ...
    #pragma region From this type to Standard types
        /// <summary>
        /// MediumDecV2Base to float explicit conversion
        /// </summary>
        /// <returns>The result of the operator.</returns>
        ...
        /// <summary>
        /// MediumDecV2Base to double explicit conversion
        /// </summary>
        /// <returns>The result of the operator.</returns>
        ...
        /// <summary>
        /// MediumDecV2Base to long double explicit conversion
        /// </summary>
        /// <returns>The result of the operator.</returns>
        ...
        /// <summary>
        /// MediumDecV2Base to int explicit conversion
        /// </summary>
        /// <returns>The result of the operator.</returns>
    ...
    #pragma region Pi Conversion
        ...
        MediumDecV2Base PiPowerNum(int powerExponent);
        ...
        MediumDecV2Base ConvertAsPiRep(const RepType& repType)
        {
            switch (repType)
            {
                case RepType::PiNum:
                ...
                case RepType::PiNumByDiv://  (Value/(ExtraRep*-1))*Pi Representation
                {
                    MediumDecV2Base Res = MediumDecV2Base(IntValue, DecimalHalf, PiRep);
                ...
                case RepType::PiFractional://  IntValue/DecimalHalf*Pi Representation
                {
                    MediumDecV2Base Res = MediumDecV2Base(IntValue, 0, PiRep);
    ...
    #pragma region E Conversion
        ...
        MediumDecV2Base ConvertAsERep(const RepType& repType)
        {
            switch (repType)
            {
                case RepType::ENum:
                ...
                case RepType::ENumByDiv://  (Value/(ExtraRep*-1))*e Representation
                {
                    MediumDecV2Base Res = MediumDecV2Base(IntValue, DecimalHalf, ERep);
                    Res.BasicUIntDivOp(-ExtraRep);
                    return Res;
                }
        #else
                case RepType::EFractional://  IntValue/DecimalHalf*e Representation
                {
                    MediumDecV2Base Res = MediumDecV2Base(IntValue, 0, ERep);
                    Res.BasicUIntDivOp(DecimalHalf);
                    return Res;
    ...
    #pragma region Other RepType Conversion
        ...
        MediumDecV2Base ConvertAsNormType(const RepType& repType); const
        ...
        MediumDecV2Base ConvertAsNormTypeV2()
        {
            MediumDecV2Base Res = *this;
		...
		MediumDecV2Base ConvertAsNormalIRep(const RepType& repType)
        {
            MediumDecV2Base Res = *this;
		...
		MediumDecV2Base ConvertIRepAsNormalV2()
        {
	        MediumDecV2Base Res = *this;
	        RepType repType = GetRepType();
        ...
        MediumDecV2Base ConvertAsNormalIRepV2()
        {
	        MediumDecV2Base Res = *this;
    ...
    #pragma region Comparison Operators
        ...
        /// <param name="RValue">The right side value</param>
        /// <returns>bool</returns>
        static bool EqualToOp(MediumDecV2Base LValue, MediumDecV2Base RValue)
        {
        ...
        /// <param name="RValue">The right side value</param>
        /// <returns>bool</returns>
        friend bool operator==(MediumDecV2Base LValue, MediumDecV2Base RValue) { return EqualToOp(LValue, RValue); }
        ...
        /// <param name="RValue">The right side value</param>
        /// <returns>bool</returns>
        static bool NotEqualToOp(MediumDecV2Base& LValue, MediumDecV2Base& RValue)
        {
            RepType LRep = LValue.GetRepType();
            RepType RRep = RValue.GetRepType();
            if (LRep != RRep)
        ...
        /// <param name="RValue">The right side value</param>
        /// <returns>bool</returns>
        friend bool operator!=(MediumDecV2Base LValue, MediumDecV2Base RValue) { return NotEqualToOp(LValue, RValue); }
        ...
        /// <param name="RValue">The right side value</param>
        /// <returns>bool</returns>
        static bool LessThanOp(MediumDecV2Base& LValue, MediumDecV2Base& RValue)
        {
            RepType LRep = LValue.GetRepType();
            RepType RRep = RValue.GetRepType();
            if (LRep != RRep)
        ...
        /// <param name="RValue">The right side value</param>
        /// <returns>bool</returns>
        friend bool operator<(MediumDecV2Base LValue, MediumDecV2Base RValue) { return LessThanOp(LValue, RValue); }
        ...
        /// <param name="RValue">The right side value</param>
        /// <returns>bool</returns>
        static bool LessThanOrEqualToOp(MediumDecV2Base& LValue, MediumDecV2Base& RValue)
        {
            RepType LRep = LValue.GetRepType();
            RepType RRep = RValue.GetRepType();
            if (LRep != RRep)
        ...
        /// <param name="RValue">The right side value</param>
        /// <returns>bool</returns>
        friend bool operator<=(MediumDecV2Base LValue, MediumDecV2Base RValue) { return LessThanOrEqualToOp(LValue, RValue); }
        ...
        /// <param name="RValue">The right side value.</param>
        /// <returns>bool</returns>
        static bool GreaterThanOp(MediumDecV2Base& LValue, MediumDecV2Base& RValue)
        {
            RepType LRep = LValue.GetRepType();
            RepType RRep = RValue.GetRepType();
            if (LRep != RRep)
        ...
        /// <param name="RValue">The right side value</param>
        /// <returns>bool</returns>
        friend bool operator>(MediumDecV2Base LValue, MediumDecV2Base RValue) { return GreaterThanOp(LValue, RValue); }
        ...
        /// <param name="RValue">The right side value</param>
        /// <returns>bool</returns>
        static bool GreaterThanOrEqualToOp(MediumDecV2Base& LValue, MediumDecV2Base& RValue)
        {
            RepType LRep = LValue.GetRepType();
            RepType RRep = RValue.GetRepType();
            if (LRep != RRep)
        ...
        /// <param name="RValue">The right side value</param>
        /// <returns>bool</returns>
        friend bool operator>=(MediumDecV2Base LValue, MediumDecV2Base RValue) { return GreaterThanOrEqualToOp(LValue, RValue); }

    #pragma endregion Comparison Operators

    #pragma region MediumDecV2Base-To-Int Comparison Functions
        /// <summary>
        /// Equality operation between <see cref="MediumDecV2Base&"/> and Integer Type.
        /// </summary>
        /// <param name="LValue">Left side MediumDecV2Base value</param>
        /// <param name="RValue">Right side integer value</param>
        /// <returns>bool</returns>
        template<typename IntType=int>
        static bool RightSideIntEqualTo(MediumDecV2Base& LValue, IntType RValue)
        {
#if defined(AltNum_EnableImaginaryNum)
    #if defined(AltNum_EnableDecimaledIFractionals)
        ...
        /// <summary>
        /// Not Equal to operation between <see cref="MediumDecV2Base&"/> and Integer Type.
        /// </summary>
        /// <param name="LValue">Left side MediumDecV2Base value</param>
        /// <param name="RValue">Right side integer value</param>
        /// <returns>bool</returns>
	    template<typename IntType=int>
        static bool RightSideIntNotEqualTo(MediumDecV2Base& LValue, IntType RValue)
        {
#if defined(AltNum_EnableImaginaryNum)
    #if defined(AltNum_EnableDecimaledIFractionals)
            if (LValue.ExtraRep<0)
        ...
        /// <summary>
        /// Less than operation between <see cref="MediumDecV2Base"/> and Integer Type.
        /// </summary>
        /// <param name="LValue">Left side MediumDecV2Base value</param>
        /// <param name="RValue">Right side integer value</param>
        /// <returns>bool</returns>
		template<typename IntType=int>
        static bool RightSideIntLessThan(MediumDecV2Base& LValue, IntType RValue)
        {
#if defined(AltNum_EnableInfinityRep)
        ...
        /// <summary>
        /// Less than or equal to operation between <see cref="MediumDecV2Base&"/> and Integer Type.
        /// </summary>
        /// <param name="LValue">Left side MediumDecV2Base value</param>
        /// <param name="RValue">Right side integer value</param>
        /// <returns>bool</returns>
	    template<typename IntType=int>
        static bool RightSideIntLessThanOrEqual(MediumDecV2Base& LValue, IntType RValue)
        {
#if defined(AltNum_EnableInfinityRep)
            if (LValue.ExtraRep == InfinityRep)
            {
        ...
        /// <summary>
        /// Greater than operation between <see cref="MediumDecV2Base&"/> and Integer Type.
        /// </summary>
        /// <param name="LValue">Left side MediumDecV2Base value</param>
        /// <param name="RValue">Right side integer value</param>
        /// <returns>bool</returns>
	    template<typename IntType=int>
        static bool RightSideIntGreaterThan(MediumDecV2Base& LValue, IntType RValue)
        {
#if defined(AltNum_EnableInfinityRep)
            if (LValue.ExtraRep == InfinityRep)
            {
        ...
        /// <summary>
        /// Greater than or equal to operation between <see cref="MediumDecV2Base&"/> and Integer Type.
        /// </summary>
        /// <param name="LValue">Left side MediumDecV2Base value</param>
        /// <param name="RValue">Right side integer value</param>
        /// <returns>bool</returns>
	    template<typename IntType=int>
        static bool RightSideIntGreaterThanOrEqual(MediumDecV2Base& LValue, IntType RValue)
        {
#if defined(AltNum_EnableInfinityRep)
            if (LValue.ExtraRep == InfinityRep)
            {
        ...
        /// <summary>
        /// Equality operation between Integer Type and <see cref="MediumDecV2Base&"/> 
        /// </summary>
        /// <param name="LValue">Left side integer value</param>
        /// <param name="RValue">Right side MediumDecV2Base value</param>
        /// <returns>bool</returns>
	    template<typename IntType=int>
        static bool LeftSideIntEqualTo(IntType LValue, MediumDecV2Base& RValue) { return RightSideIntEqualTo(RValue, LValue); }
	
        /// <summary>
        /// Not equal to operation between Integer Type and <see cref="MediumDecV2Base&"/> 
        /// </summary>
        /// <param name="LValue">Left side integer value</param>
        /// <param name="RValue">Right side MediumDecV2Base value</param>
        /// <returns>bool</returns>
	    template<typename IntType=int>
        static bool LeftSideIntNotEqualTo(IntType LValue, MediumDecV2Base& RValue) { return RightSideIntNotEqualTo(RValue, LValue); }
		
        /// <summary>
        /// Less than operation between Integer Type and <see cref="MediumDecV2Base&"/> 
        /// </summary>
        /// <param name="LValue">Left side integer value</param>
        /// <param name="RValue">Right side MediumDecV2Base value</param>
        /// <returns>bool</returns>
	    template<typename IntType=int>
        static bool LeftSideIntLessThan(IntType LValue, MediumDecV2Base& RValue) { return RightSideIntGreaterThan(RValue, LValue); }
		
        /// <summary>
        /// Less than or equal operation between Integer Type and <see cref="MediumDecV2Base&"/> 
        /// </summary>
        /// <param name="LValue">Left side integer value</param>
        /// <param name="RValue">Right side MediumDecV2Base value</param>
        /// <returns>bool</returns>
	    template<typename IntType=int>
        static bool LeftSideIntLessThanOrEqual(IntType LValue, MediumDecV2Base& RValue) { return RightSideIntGreaterThanOrEqual(RValue, LValue); }
		
        /// <summary>
        /// Greater than operation between Integer Type and <see cref="MediumDecV2Base&"/> 
        /// </summary>
        /// <param name="LValue">Left side integer value</param>
        /// <param name="RValue">Right side MediumDecV2Base value</param>
        /// <returns>bool</returns>
		template<typename IntType=int>
        static bool LeftSideIntGreaterThan(IntType LValue, MediumDecV2Base& RValue) { return RightSideIntLessThan(RValue, LValue); }
        ...
        /// <returns>bool</returns>
		template<typename IntType=int>
        static bool LeftSideIntGreaterThanOrEqual(IntType LValue, MediumDecV2Base& RValue) { return RightSideIntLessThanOrEqual(RValue, LValue); }

    #pragma endregion MediumDecV2Base-To-Int Comparison Methods
...
public:
        ...
        /// <summary>
        /// Division Operation Between MediumDecV2Base and unsigned Integer Value that ignores special representation status
        ...
        /// <summary>
        /// Division Operation Between MediumDecV2Base and Integer Value that ignores special representation status
        /// </summary>
        /// <param name="lValue">The left side value.</param>
        /// <param name="rValue">The right side value.</param>
        template<typename IntType=int>
...
protected:
		/// <summary>
        /// Partial Multiplication Operation Between MediumDecV2Base and Integer Value
...
public:
        /// <summary>
        /// Multiplication Operation Between MediumDecV2Base and Integer Value
        /// (Modifies owner object)
        /// </summary>
        /// <param name="rValue">The right side value.</param>
        template<typename IntType>
        ...
        /// <summary>
        /// Multiplication Operation Between MediumDecV2Base and unsigned Integer Value
        /// (Modifies owner object)
        /// </summary>
        /// <param name="rValue">The right side value.</param>
        template<typename IntType>
...
public:
        ...
        /// <summary>
        /// Basic Addition Operation between MediumDecV2Base and Integer value 
        ...
        MediumDecV2Base& BasicIntAddOp(const IntType& rValue)
        {
            ...
            else
            {
                ...
                if(NegativeBeforeOperation^(IntValue<0))
                    DecimalHalf = MediumDecV2Base::DecimalOverflow - DecimalHalf;
            }
            return *this;
        }

        /// <summary>
        /// Addition Operation Between MediumDecV2Base and  Integer Value that ignores special representation status
        /// (Modifies lValue during operation) 
        /// </summary>
        /// <param name="lValue">The left side value.</param>
        /// <param name="rValue">The right side value.</param>
        ...
        /// <summary>
        /// Subtraction Operation Between MediumDecV2Base and unsigned Integer Value that ignores special representation status
        /// </summary>
        /// <param name="lValue">The left side value.</param>
        /// <param name="rValue">The right side value.</param>
        template<typename IntType=int>
...
public:
		...
		/// <summary>
        /// Basic Subtraction Operation between MediumDecV2Base and Integer value 
        /// that ignores special representation status
        /// (Modifies owner object)
        /// </summary>
        /// <param name="rValue">The right side value.</param>
    ...
    #pragma region Mixed Fraction Operations
		...
		void BasicMixedFracAddOp(MediumDecV2Base& rValue)
		{
			...
			{
				MediumDecV2Base RightSideNum = MediumDecV2Base(rValue.IntValue==0?-rValue.DecimalHalf:rValue.IntValue*rValue.ExtraRep - rValue.DecimalHalf);
	...
	#if defined(AltNum_EnableMixedPiFractional)
		void BasicMixedPiFracAddOp(MediumDecV2Base& rValue)
	#elif defined(AltNum_EnableMixedEFractional)
		void BasicMixedEFracAddOp(MediumDecV2Base& rValue)
	#endif
		...
		//Assumes NormalRep - Normal MixedFraction operation
		void BasicMixedFracSubOp(MediumDecV2Base& rValue)
		{
			MediumDecV2Base RightSideNum = MediumDecV2Base(rValue.IntValue==0?-rValue.DecimalHalf:rValue.IntValue*rValue.ExtraRep - rValue.DecimalHalf);
	...
	#if defined(AltNum_EnableMixedPiFractional)
		void BasicMixedPiFracSubOp(MediumDecV2Base& rValue)
	#elif defined(AltNum_EnableMixedEFractional)
		void BasicMixedEFracSubOp(MediumDecV2Base& rValue)
	#endif
	#if defined(AltNum_MixedPiOrEEnabled)
		{
			MediumDecV2Base RightSideNum = MediumDecV2Base(rValue.IntValue==0?-rValue.DecimalHalf:(rValue.IntValue*-rValue.ExtraRep) - rValue.DecimalHalf);
...
protected:
        ...
        bool PartialDivOp(const MediumDecV2Base& rValue)
        {
        ...
        bool UnsignedPartialDivOp(const MediumDecV2Base& rValue)
        {
            bool ResIsPositive = true;
            signed _int64 SelfRes;
            signed _int64 ValueRes;
...
public:
        ...
        /// </summary>
        /// <param name="rValue.">The rValue</param>
        MediumDecV2Base& BasicUnsignedDivOp(const MediumDecV2Base& rValue)
        {
        ...
        //Performs division operation ignoring non-normal representation with right side MediumDecV2Base
        MediumDecV2Base BasicDiv(const MediumDecV2Base& rValue)
        { MediumDecV2Base self = *this; self.BasicUnsignedDivOp(rValue); return self; }

        //Performs division operation (without checking negative) ignoring non-normal representation with right side MediumDecV2Base
        MediumDecV2Base BasicUnsignedDiv(const MediumDecV2Base& rValue) 
        { MediumDecV2Base self = *this; self.BasicUnsignedDivOp(rValue);  return self; }

        MediumDecV2Base BasicDivision(MediumDecV2Base self, const MediumDecV2Base& rValue)
        {
        ...
        MediumDecV2Base BasicUnsignedDivision(MediumDecV2Base self, const MediumDecV2Base& rValue)
        {
...
public:
        ...
        /// </summary>
        /// <param name="rValue.">The right side Value</param>
		MediumDecV2Base& BasicMultOp(const MediumDecV2Base& rValue)
		{
            if (DecimalHalf == 0)
            {
                if (IntValue == 1)
            ...
            else
            {
                ...
                if (IntValue == 0)
                {
                    ...
                    SRep /= MediumDecV2Base::DecimalOverflowX;
                    if (rValue.IntValue == 0)
                    {
                        DecimalHalf = (signed int)SRep;
                    ...
                    else
                    {
                        ...
                        if (SRep >= MediumDecV2Base::DecimalOverflowX)
                        {
                            __int64 OverflowVal = SRep / MediumDecV2Base::DecimalOverflowX;
                            SRep -= OverflowVal * MediumDecV2Base::DecimalOverflowX;
                ...
                {
                    __int64 SRep = MediumDecV2Base::DecimalOverflowX * IntValue + DecimalHalf;
                    if (rValue < 0)
                    {
                    ...
                    else
                    {
                            ...
                            IntValue = SelfIsNegative ? MediumDecV2Base::NegativeRep : 0;
                            return *this;
                    }
                }
                else if (rValue.IntValue == 0)
                ...
                else
                {
                    ...
                    __int64 SRep = IntValue == 0 ? DecimalHalf : MediumDecV2Base::DecimalOverflowX * IntValue + DecimalHalf;
                    //X.Y *.V
                    if(rValue<0)
                    {
                        SRep *= -rValue.IntValue;
                    ...
                    if (IntHalf == 0)
                        IntValue = (signed int)SelfIsNegative ? MediumDecV2Base::NegativeRep : 0;
                    else
        ...
        /// </summary>
        /// <param name="rValue.">The right side Value</param>
		MediumDecV2Base& BasicUnsignedMultOp(const MediumDecV2Base& rValue)
		{
            if (DecimalHalf == 0)
            {
                if (IntValue == 1)
            ...
            else if (IntValue == MediumDecV2Base::NegativeRep)
            {
                __int64 SRep = (__int64)DecimalHalf;
                SRep *= rValue.DecimalHalf;
                SRep /= MediumDecV2Base::DecimalOverflowX;
        ...
        MediumDecV2Base BasicMult(const MediumDecV2Base& rValue) { MediumDecV2Base self = *this; self.BasicUnsignedDivOp(rValue); return self; }

        MediumDecV2Base BasicUnsignedMult(const MediumDecV2Base& rValue) { MediumDecV2Base self = *this; self.BasicUnsignedMultOp(rValue); return self; }

        MediumDecV2Base BasicMultiplication(MediumDecV2Base self, const MediumDecV2Base& rValue)
        {
            return self.BasicMultOp(rValue);
        }

        MediumDecV2Base BasicUnsignedMultiplication(MediumDecV2Base self, const MediumDecV2Base& rValue)
        {
            return self.BasicUnsignedMultOp(rValue);
        }

        template<typename MediumDecV2BaseVariant = MediumDecV2Base>
        MediumDecV2Base BasicMult(const MediumDecV2Base& rValue) { MediumDecV2Base self = *this; self.BasicMultOp(rValue); return self; }
	...
	#pragma region NormalRep AltNum Addition Operations
        ...
        void BasicAddOp(const MediumDecV2Base& rValue)
        {
        ...
        /// </summary>
        /// <param name="rValue.">The right side rValue</param>
        void BasicUnsignedAddOp(const MediumDecV2Base& rValue)
        {
            //NegativeBeforeOperation
            bool WasNegative = IntValue < 0;
            //Deal with Int section first
	...
	#pragma region NormalRep AltNum Subtraction Operations
        ...
        /// </summary>
        /// <param name="rValue.">The right side rValue</param>
		void BasicSubOp(const MediumDecV2Base& rValue)
        {
            //NegativeBeforeOperation
            bool WasNegative = IntValue < 0;
            //Deal with Int section first
        ...
        /// </summary>
        /// <param name="rValue.">The right side rValue</param>
		void BasicUnsignedSubOp(const MediumDecV2Base& rValue)
        {
            //NegativeBeforeOperation
            bool WasNegative = IntValue < 0;
            //Deal with Int section first
    ...
    #pragma region Other Division Operations
        ...
        /// <summary>
        /// Division Operation Between MediumDecV2Base and Integer rValue.
        /// (Modifies owner object)
        /// </summary>
        /// <param name="rValue.">The right side Value</param>
        /// <returns>MediumDecV2Base&</returns>
        ...
        /// <summary>
        /// Division Operation Between MediumDecV2Base and unsigned Integer rValue.
        /// (Modifies owner object)
        /// </summary>
        /// <param name="rValue.">The right side Value</param>
        /// <returns>MediumDecV2Base&</returns>
...
public:
        ...
        /// <summary>
        /// Multiplication Operation Between MediumDecV2Base and Integer rValue.
        /// (Modifies owner object)
        /// </summary>
        /// <param name="rValue.">The right side Value</param>
        /// <returns>MediumDecV2Base&</returns>
        ...
        /// <summary>
        /// Multiplication Operation Between MediumDecV2Base and unsigned Integer rValue.
        /// (Modifies owner object)
        /// </summary>
        /// <param name="rValue.">The right side Value</param>
        /// <returns>MediumDecV2Base&</returns>
...
public:
        ...
        /// <summary>
        /// Addition MediumDecV2Base modifying operation with right side Integer rValue.
        ...
        MediumDecV2Base& IntAddOp(const IntType& rValue)
        {
            ...
            if(ExtraRep==IRep)
            {
                throw "Can't convert MediumDecV2Base into complex number at moment";
				return *this;
            }
	#endif
	#if defined(AltNum_EnableInfinityRep)
        ...
        /// <summary>
        /// Addition Operation Between MediumDecV2Base and Integer Value.
        /// </summary>
        /// <param name="self">The self.</param>
        /// <param name="rValue.">The rValue</param>
        /// <returns>MediumDecV2Base</returns>
    ...
    #pragma region Other Subtraction Operations
        ...
        /// <summary>
        /// Subtraction MediumDecV2Base modifying operation with right side Integer rValue.
        /// (copy by parameter and pointer version)
        /// </summary>
        /// <param name="self">The self.</param>
        /// <param name="rValue.">The rValue</param>
...
public:
		...
		void CatchAllDivision(MediumDecV2Base& rValue, const RepType& LRep, const RepType& RRep)
		{
			ConvertToNormType(LRep);
			MediumDecV2Base convertedRVal = rValue.ConvertAsNormType(RRep);
			BasicMultOp(convertedRVal);
		}

        MediumDecV2Base CatchAllDivisionAsCopies(MediumDecV2Base& rValue, const RepType& LRep, const RepType& RRep)
        { MediumDecV2Base self = *this; CatchAllDivision(rValue, LRep, RRep); return self; }
		
		void CatchAllDivisionV2(MediumDecV2Base& rValue, const RepType& SameRep)
		{
            ConvertToNormType(SameRep);
			MediumDecV2Base convertedRVal = rValue.ConvertAsNormType(SameRep);
			BasicUnsignedDivOp(convertedRVal);
		}

        MediumDecV2Base CatchAllDivisionAsCopiesV2(MediumDecV2Base& rValue, const RepType& SameRep)
        { MediumDecV2Base self = *this; CatchAllDivisionV2(rValue, SameRep); return self; }
	
	   void CatchAllDivisionV3(MediumDecV2Base& rValue)
	   {
			ConvertToNormTypeV2();
            MediumDecV2Base convertedRVal = rValue.ConvertAsNormTypeV2();
			BasicUnsignedDivOp(convertedRVal);
	   }

        MediumDecV2Base CatchAllDivisionAsCopiesV3(MediumDecV2Base& rValue)
        { MediumDecV2Base self = *this; CatchAllDivisionV3(rValue); return self; }
		
	//Both sides are assumed to be imaginary number types of representations for CatchAllImaginary..
	#if defined(AltNum_EnableImaginaryNum)
		void CatchAllImaginaryDivision(MediumDecV2Base& rValue, const RepType& LRep, const RepType& RRep)
		{
		   ConvertIRepToNormal(LRep);
           MediumDecV2Base convertedRVal = rValue.ConvertAsNormalIRep(RRep);
		   BasicUnsignedDivOp(convertedRVal);
		   ExtraRep = 0;
		}

        MediumDecV2Base CatchAllImaginaryDivisionAsCopies(MediumDecV2Base& rValue, const RepType& LRep, const RepType& RRep)
        { MediumDecV2Base self = *this; CatchAllImaginaryDivision(rValue, LRep, RRep); return self; }
		
		void CatchAllImaginaryDivisionV2(MediumDecV2Base& rValue, const RepType& SameRep)
		{
            ConvertIRepToNormal(SameRep);
            MediumDecV2Base convertedRVal = rValue.ConvertAsNormalIRep(SameRep);
            BasicUnsignedDivOp(convertedRVal);
            ExtraRep = 0;
		}

        MediumDecV2Base CatchAllImaginaryDivisionAsCopiesV2(MediumDecV2Base& rValue, const RepType& SameRep)
        { MediumDecV2Base self = *this; CatchAllImaginaryDivisionV2(rValue, SameRep); return self; }
	
        void CatchAllImaginaryDivisionV3(MediumDecV2Base& rValue)
        {
           ConvertIRepToNormalV2();
           MediumDecV2Base convertedRVal = rValue.ConvertAsNormalIRepV2();
           BasicUnsignedDivOp(convertedRVal);
           ExtraRep = 0;
        }

        MediumDecV2Base CatchAllImaginaryDivisionAsCopiesV3(MediumDecV2Base& rValue)
        { MediumDecV2Base self = *this; CatchAllImaginaryDivisionV3(rValue); return self; }
	#endif

public:
        static void RepToRepDivOp(RepType& LRep, RepType& RRep, MediumDecV2Base& self, MediumDecV2Base Value);
        ...
        /// <returns>MediumDecV2Base&</returns>
        MediumDecV2Base& DivOp(MediumDecV2Base rValue)
        {
            ...
            if (LRep == RRep)
            {
                ...
                case RepType::PiPower:
                    ...
                    {
                        MediumDecV2Base PiPowerDivisor = PiPowerNum(ExtraRep - rValue.ExtraRep);
                        ExtraRep = 0;
                ...
                case RepType::NumByDiv://(MediumDecV2Base(IntValue,DecimalHalf))/ExtraRep
                {
                    //((MediumDecV2Base(IntValue,DecimalHalf))/ExtraRep) / (MediumDecV2Base(rValue.IntValue,rValue.DecimalHalf))/rValue.ExtraRep) = 
                    //((MediumDecV2Base(IntValue,DecimalHalf))* rValue.ExtraRep/ExtraRep) /(MediumDecV2Base(rValue.IntValue,rValue.DecimalHalf)))
                    if (rValue < 0)
                    {
                        rValue *= -1;
                        SwapNegativeStatus();
                ...
                case RepType::MixedFrac://IntValue +- (-DecimalHalf/ExtraRep)
                {
                    ...
                    MediumDecV2Base LeftSideNum;
                    if (IntValue == NegativeRep)
                        LeftSideNum = MediumDecV2Base(DecimalHalf);
                    else if (IntValue < 0)
                        LeftSideNum = MediumDecV2Base(IntValue * ExtraRep + DecimalHalf);
                    else if (IntValue == 0)
                        LeftSideNum = MediumDecV2Base(-DecimalHalf);
                    else
                        LeftSideNum = MediumDecV2Base(IntValue * ExtraRep - DecimalHalf);
...
#endif
                default:
                    throw MediumDecV2Base::RepTypeAsString(LRep) + " RepType division not supported yet";
                    break;
                }
            }
            else
   ...
   MediumDecV2Base DivideBy(const MediumDecV2Base& rValue) { MediumDecV2Base self = *this; self.DivOp(rValue); return self; }
        ...
        MediumDecV2Base DivideByUnsigned(const MediumDecV2Base& rValue) { MediumDecV2Base self = *this; self.UnsignedDivOp(rValue); return self; }

		void CatchAllMultiplication(MediumDecV2Base& rValue, const RepType& LRep, const RepType& RRep)
		{
			ConvertToNormType(LRep);
			MediumDecV2Base convertedRVal = rValue.ConvertAsNormType(RRep);
			BasicMultOp(convertedRVal);
		...
		void CatchAllMultiplicationV2(MediumDecV2Base& rValue, const RepType& SameRep)
		{
            ConvertToNormType(SameRep);
			MediumDecV2Base convertedRVal = rValue.ConvertAsNormType(SameRep);
			BasicMultOp(convertedRVal);
		...
		void CatchAllMultiplicationV3(MediumDecV2Base& rValue)
		{
			ConvertToNormTypeV2();
            MediumDecV2Base convertedRVal = rValue.ConvertAsNormTypeV2();
			BasicMultOp(convertedRVal);
	...
	//Both sides are assumed to be imaginary number types of representations for CatchAllImaginary..
	#if defined(AltNum_EnableImaginaryNum)
		void CatchAllImaginaryMultiplication(MediumDecV2Base& rValue, const RepType& LRep, const RepType& RRep)
		{
		   ConvertIRepToNormal(LRep);
           MediumDecV2Base convertedRVal = rValue.ConvertAsNormalIRep(RRep);
		   BasicMultOp(convertedRVal);
        ...
        MediumDecV2Base CatchAllImaginaryMultiplicationAsCopies(MediumDecV2Base& rValue, const RepType& LRep, const RepType& RRep)
        { MediumDecV2Base self = *this; CatchAllImaginaryMultiplication(rValue, LRep, RRep); return self; }
		
		void CatchAllImaginaryMultiplicationV2(MediumDecV2Base& rValue, const RepType& SameRep)
		{
            ConvertIRepToNormal(SameRep);
            MediumDecV2Base convertedRVal = rValue.ConvertAsNormalIRep(SameRep);
            BasicMultOp(convertedRVal);
        ...
        MediumDecV2Base CatchAllImaginaryMultiplicationAsCopiesV2(MediumDecV2Base& rValue, const RepType& SameRep) 
        { MediumDecV2Base self = *this; CatchAllImaginaryMultiplicationV2(rValue, SameRep); return self; }
	
	   void CatchAllImaginaryMultiplicationV3(MediumDecV2Base& rValue)
	   {
           ConvertIRepToNormalV2();
           MediumDecV2Base convertedRVal = rValue.ConvertAsNormalIRepV2();
           BasicMultOp(convertedRVal);
        ...
        MediumDecV2Base CatchAllImaginaryMultiplicationAsCopiesV3(MediumDecV2Base& rValue)
        { MediumDecV2Base self = *this; CatchAllImaginaryMultiplicationV3(rValue); return self; }
	#endif

        static void RepToRepMultOp(RepType& LRep, RepType& RRep, MediumDecV2Base& self, MediumDecV2Base rValue);
        ...
        /// <param name="rValue.">The rightside rValue</param>
        /// <returns>MediumDecV2Base&</returns>
        MediumDecV2Base& MultOp(MediumDecV2Base rValue)
        {
            if (rValue.IntValue==0&&rValue.DecimalHalf==0) { SetAsZero(); return *this; }
            if (IsZero() || rValue == MediumDecV2Base::One)
                return *this;
#if defined(AltNum_EnableInfinityRep)
            if (DecimalHalf == InfinityRep)
            {
            ...
            if (LRep == RRep)
            {
                ...
                case RepType::ApproachingMidLeft:
                {
                    ...
                    else if(rValue<0)
                    {
                        ...
                        MediumDecV2Base XV = SetAsApproachingMid(0, rValue.ExtraRep) * IntValue;
                        MediumDecV2Base YZ = SetAsApproachingMid(0, ExtraRep) * InvertedrValue;
                        MediumDecV2Base YV = SetAsApproachingMid(0, ExtraRep) * SetAsApproachingMid(0, rValue.ExtraRep);
                        XV += XZ;
                        XV += YZ + YV;
                        if (IsNegative)
                    ...
                    {//X.Y * Z.V == ((X * Z) + (X * .V) + (.Y * Z) + (.Y * .V))
                        ...
                        MediumDecV2Base XV = SetAsApproachingMid(0, rValue.ExtraRep) * IntValue;
                        MediumDecV2Base YZ = SetAsApproachingMid(0, ExtraRep) * rValue.IntValue;
                        MediumDecV2Base YV = SetAsApproachingMid(0, ExtraRep) * SetAsApproachingMid(0, rValue.ExtraRep);
                        XV += XZ;
                        XV += YZ + YV;
                        if (IsNegative)
                ...
                {
                    //((MediumDecV2Base(IntValue,DecimalHalf))/ExtraRep) * (MediumDecV2Base(rValue.IntValue,rValue.DecimalHalf))/rValue.ExtraRep) = 
                    //((MediumDecV2Base(IntValue,DecimalHalf))*MediumDecV2Base(rValue.IntValue,rValue.DecimalHalf)))/(ExtraRep*rValue.ExtraRep)
                    BasicMultOp(rValue);
                    ExtraRep *= rValue.ExtraRep;
                }
                break;
...
#endif
                default:
                    throw MediumDecV2Base::RepTypeAsString(LRep) + " RepType multiplication not supported yet";
                    break;
                }
            }
            else
        ...
        MediumDecV2Base MultipleBy(const MediumDecV2Base& rValue) { MediumDecV2Base self = *this; self.MultOp(rValue); return self; }
        ...
        MediumDecV2Base MultipleByUnsigned(const MediumDecV2Base& rValue) { MediumDecV2Base self = *this; self.UnsignedMultOp(rValue); return self; }

		void CatchAllAddition(MediumDecV2Base& rValue, const RepType& LRep, const RepType& RRep)
		{
			ConvertToNormType(LRep);
			MediumDecV2Base convertedRVal = rValue.ConvertAsNormType(RRep);
			BasicMultOp(convertedRVal);
        ...
        MediumDecV2Base CatchAllAdditionAsCopies(MediumDecV2Base& rValue, const RepType& LRep, const RepType& RRep)
        { MediumDecV2Base self = *this; CatchAllAddition(rValue, LRep, RRep); return self; }
		
		void CatchAllAdditionV2(MediumDecV2Base& rValue, const RepType& SameRep)
		{
            ConvertToNormType(SameRep);
			MediumDecV2Base convertedRVal = rValue.ConvertAsNormType(SameRep);
        ...
        MediumDecV2Base CatchAllAdditionAsCopiesV2(MediumDecV2Base& rValue, const RepType& SameRep)
        { MediumDecV2Base self = *this; CatchAllAdditionV2(rValue, SameRep); return self; }
	
	   void CatchAllAdditionV3(MediumDecV2Base& rValue)
	   {
			ConvertToNormTypeV2();
            MediumDecV2Base convertedRVal = rValue.ConvertAsNormTypeV2();
			BasicAddOp(convertedRVal);
        ...
        MediumDecV2Base CatchAllAdditionAsCopiesV3(MediumDecV2Base& rValue)
        { MediumDecV2Base self = *this; CatchAllAdditionV3(rValue); return self; }
		
	//Both sides are assumed to be imaginary number types of representations for CatchAllImaginary..
	#if defined(AltNum_EnableImaginaryNum)
		void CatchAllImaginaryAddition(MediumDecV2Base& rValue, const RepType& LRep, const RepType& RRep)
		{
		   ConvertIRepToNormal(LRep);
           MediumDecV2Base convertedRVal = rValue.ConvertAsNormalIRep(RRep);
		   BasicAddOp(convertedRVal);
        ...
        MediumDecV2Base CatchAllImaginaryAdditionAsCopies(MediumDecV2Base& rValue, const RepType& LRep, const RepType& RRep)
        { MediumDecV2Base self = *this; CatchAllImaginaryAddition(rValue, LRep, RRep); return self; }
		
		void CatchAllImaginaryAdditionV2(MediumDecV2Base& rValue, const RepType& SameRep)
		{
            ConvertIRepToNormal(SameRep);
            MediumDecV2Base convertedRVal = rValue.ConvertAsNormalIRep(SameRep);
            BasicAddOp(convertedRVal);
        ...
        MediumDecV2Base CatchAllImaginaryAdditionAsCopiesV2(MediumDecV2Base& rValue, const RepType& SameRep)
        { MediumDecV2Base self = *this; CatchAllImaginaryAdditionV2(rValue, SameRep); return self; }
	
        void CatchAllImaginaryAdditionV3(MediumDecV2Base& rValue)
        {
           ConvertIRepToNormalV2();
           MediumDecV2Base convertedRVal = rValue.ConvertAsNormalIRepV2();
           BasicAddOp(convertedRVal);
        ...
        MediumDecV2Base CatchAllImaginaryAdditionAsCopiesV3(MediumDecV2Base& rValue)
        { MediumDecV2Base self = *this; CatchAllImaginaryAdditionV3(rValue); return self; }
	#endif

        static void RepToRepAddOp(RepType& LRep, RepType& RRep, MediumDecV2Base& self, MediumDecV2Base rValue);

        /// <summary>
        /// Addition Operation  with right side MediumDecV2Base
        /// (Modifies owner object)
        /// </summary>
        /// <param name="rValue.">The rightside rValue</param>
        /// <returns>MediumDecV2Base&</returns>
        MediumDecV2Base& AddOp(MediumDecV2Base rValue)
        {
            if (IsZero())
            {
                IntValue = rValue.IntValue; DecimalHalf = rValue.DecimalHalf;
...
#endif
                default:
                    throw MediumDecV2Base::RepTypeAsString(LRep) + " RepType addition not supported yet";
                    break;
                }
            }
            else
        ...
        MediumDecV2Base AddBy(const MediumDecV2Base& rValue) { MediumDecV2Base self = *this; self.AddOp(rValue); return self; }

		void CatchAllSubtraction(MediumDecV2Base& rValue, const RepType& LRep, const RepType& RRep)
		{
			ConvertToNormType(LRep);
			MediumDecV2Base convertedRVal = rValue.ConvertAsNormType(RRep);
			BasicMultOp(convertedRVal);
        ...
        MediumDecV2Base CatchAllSubtractionAsCopies(MediumDecV2Base& rValue, const RepType& LRep, const RepType& RRep)
        { MediumDecV2Base self = *this; CatchAllSubtraction(rValue, LRep, RRep); return self; }
		
		void CatchAllSubtractionV2(MediumDecV2Base& rValue, const RepType& SameRep)
		{
            ConvertToNormType(SameRep);
			MediumDecV2Base convertedRVal = rValue.ConvertAsNormType(SameRep);
        ...
        MediumDecV2Base CatchAllSubtractionAsCopiesV2(MediumDecV2Base& rValue, const RepType& SameRep)
        { MediumDecV2Base self = *this; CatchAllSubtractionV2(rValue, SameRep); return self; }
	
	   void CatchAllSubtractionV3(MediumDecV2Base& rValue)
	   {
			ConvertToNormTypeV2();
            MediumDecV2Base convertedRVal = rValue.ConvertAsNormTypeV2();
			BasicSubOp(convertedRVal);
        ...
        MediumDecV2Base CatchAllSubtractionAsCopiesV3(MediumDecV2Base& rValue)
        { MediumDecV2Base self = *this; CatchAllSubtractionV3(rValue); return self; }
		
	//Both sides are assumed to be imaginary number types of representations for CatchAllImaginary..
	#if defined(AltNum_EnableImaginaryNum)
		void CatchAllImaginarySubtraction(MediumDecV2Base& rValue, const RepType& LRep, const RepType& RRep)
		{
		   ConvertIRepToNormal(LRep);
           MediumDecV2Base convertedRVal = rValue.ConvertAsNormalIRep(RRep);
		   BasicSubOp(convertedRVal);
        ...
        MediumDecV2Base CatchAllImaginarySubtractionAsCopies(MediumDecV2Base& rValue, const RepType& LRep, const RepType& RRep)
        { MediumDecV2Base self = *this; CatchAllImaginarySubtraction(rValue, LRep, RRep); return self; }
		
		void CatchAllImaginarySubtractionV2(MediumDecV2Base& rValue, const RepType& SameRep)
		{
            ConvertIRepToNormal(SameRep);
            MediumDecV2Base convertedRVal = rValue.ConvertAsNormalIRep(SameRep);
            BasicSubOp(convertedRVal);
        ...
        MediumDecV2Base CatchAllImaginarySubtractionAsCopiesV2(MediumDecV2Base& rValue, const RepType& SameRep)
        { MediumDecV2Base self = *this; CatchAllImaginarySubtractionV2(rValue, SameRep); return self; }
	
        void CatchAllImaginarySubtractionV3(MediumDecV2Base& rValue)
        {
           ConvertIRepToNormalV2();
           MediumDecV2Base convertedRVal = rValue.ConvertAsNormalIRepV2();
           BasicSubOp(convertedRVal);
        ...
        MediumDecV2Base CatchAllImaginarySubtractionAsCopiesV3(MediumDecV2Base& rValue)
        { MediumDecV2Base self = *this; CatchAllImaginarySubtractionV3(rValue); return self; }
	#endif

        static void RepToRepSubOp(RepType& LRep, RepType& RRep, MediumDecV2Base& self, MediumDecV2Base rValue);

        /// <summary>
        /// Subtraction Operation  with right side MediumDecV2Base
        /// (Modifies owner object)
        /// </summary>
        /// <param name="rValue.">The rightside rValue</param>
        /// <returns>MediumDecV2Base&</returns>
        MediumDecV2Base& SubOp(MediumDecV2Base rValue)
        {
            if (IsZero())
            {
                IntValue = rValue.IntValue; DecimalHalf = rValue.DecimalHalf;
...
#endif
                default:
                    throw MediumDecV2Base::RepTypeAsString(LRep) + " RepType subtraction not supported yet";
                    break;
                }
            }
            else
        ...
        MediumDecV2Base SubtractBy(const MediumDecV2Base& rValue) { MediumDecV2Base self = *this; self.SubOp(rValue); return self; }
    ...
    #pragma region Main Operator Overrides
        ...
        /// <param name="rValue">The right side value.</param>
        /// <returns>MediumDecV2Base</returns>
        MediumDecV2Base& operator/=(const MediumDecV2Base& rValue) { return DivOp(rValue); }
        ...
        /// <param name="rValue">The value.</param>
        /// <returns>MediumDecV2Base</returns>
        MediumDecV2Base& operator/=(const signed int& rValue) { return IntDivOp(rValue); }
        MediumDecV2Base& operator/=(const unsigned int& rValue) { return UIntDivOp(rValue); }
        MediumDecV2Base& operator/=(const unsigned __int64& rValue) { return UIntDivOp(rValue); }
        MediumDecV2Base& operator/=(const signed __int64& rValue) { return IntDivOp(rValue); }
        MediumDecV2Base& operator/=(const signed __int16& rValue) { return IntDivOp(rValue); }
        MediumDecV2Base& operator/=(const signed __int8& rValue) { return IntDivOp(rValue); }
        MediumDecV2Base& operator/=(const unsigned __int16& rValue) { return UIntDivOp(rValue); }
        MediumDecV2Base& operator/=(const unsigned __int8& rValue) { return UIntDivOp(rValue); }
        ...
        /// <param name="rValue">The right side value.</param>
        /// <returns>MediumDecV2Base</returns>
        friend MediumDecV2Base operator/(MediumDecV2Base self, const MediumDecV2Base& rValue) { return self.DivOp(rValue); }
        friend MediumDecV2Base operator/(MediumDecV2Base self, const int& rValue) { return self.IntDivOp(rValue); }
        friend MediumDecV2Base operator/(MediumDecV2Base self, const unsigned int rValue) { return self.UIntDivOp(rValue); }
        friend MediumDecV2Base operator/(MediumDecV2Base self, const signed long long rValue) { return self.IntDivOp(rValue); }
        friend MediumDecV2Base operator/(MediumDecV2Base self, const unsigned __int64 rValue) { return self.UIntDivOp(rValue); }
        friend MediumDecV2Base operator/(MediumDecV2Base self, const __int16& rValue) { return self.IntDivOp(rValue); }
        friend MediumDecV2Base operator/(MediumDecV2Base self, const unsigned __int16& rValue) { return self.UIntDivOp(rValue); }
        friend MediumDecV2Base operator/(MediumDecV2Base self, const signed __int8& rValue) { return self.IntDivOp(rValue); }
        friend MediumDecV2Base operator/(MediumDecV2Base self, const unsigned __int64& rValue) { return self.UIntDivOp(rValue); }
        ...
        /// <param name="rValue">The right side value.</param>
        /// <returns>MediumDecV2Base</returns>
        MediumDecV2Base& operator*=(const MediumDecV2Base& rValue) { return MultOp(rValue); }
        ...
        /// <param name="rValue">The value.</param>
        /// <returns>MediumDecV2Base</returns>
        MediumDecV2Base& operator*=(const signed int& rValue) { return IntMultOp(rValue); }
        MediumDecV2Base& operator*=(const unsigned int& rValue) { return UIntMultOp(rValue); }
        MediumDecV2Base& operator*=(const unsigned __int64& rValue) { return UIntMultOp(rValue); }
        MediumDecV2Base& operator*=(const signed __int64& rValue) { return IntMultOp(rValue); }
        MediumDecV2Base& operator*=(const signed __int16& rValue) { return IntMultOp(rValue); }
        MediumDecV2Base& operator*=(const signed __int8& rValue) { return IntMultOp(rValue); }
        MediumDecV2Base& operator*=(const unsigned __int16& rValue) { return UIntMultOp(rValue); }
        MediumDecV2Base& operator*=(const unsigned __int8& rValue) { return UIntMultOp(rValue); }
        ...
        /// <param name="rValue">The right side value.</param>
        /// <returns>MediumDecV2Base</returns>
        friend MediumDecV2Base operator*(MediumDecV2Base self, const MediumDecV2Base& rValue) { return self.MultOp(rValue); }
        friend MediumDecV2Base operator*(MediumDecV2Base self, const int& rValue) { return self.IntMultOp(rValue); }
        friend MediumDecV2Base operator*(MediumDecV2Base self, const unsigned int rValue) { return self.UIntMultOp(rValue); }
        friend MediumDecV2Base operator*(MediumDecV2Base self, const signed long long rValue) { return self.IntMultOp(rValue); }
        friend MediumDecV2Base operator*(MediumDecV2Base self, const unsigned __int64 rValue) { return self.UIntMultOp(rValue); }
        friend MediumDecV2Base operator*(MediumDecV2Base self, const __int16& rValue) { return self.IntMultOp(rValue); }
        friend MediumDecV2Base operator*(MediumDecV2Base self, const unsigned __int16& rValue) { return self.UIntMultOp(rValue); }
        friend MediumDecV2Base operator*(MediumDecV2Base self, const signed __int8& rValue) { return self.IntMultOp(rValue); }
        friend MediumDecV2Base operator*(MediumDecV2Base self, const unsigned __int64& rValue) { return self.UIntMultOp(rValue); }
        ...
        /// <param name="rValue">The right side value.</param>
        /// <returns>MediumDecV2Base</returns>
        MediumDecV2Base& operator+=(const MediumDecV2Base& rValue) { return AddOp(rValue); }
        ...
        /// <param name="rValue">The value.</param>
        /// <returns>MediumDecV2Base</returns>
        MediumDecV2Base& operator+=(const signed int& rValue) { return IntAddOp(rValue); }
        MediumDecV2Base& operator+=(const unsigned int& rValue) { return IntAddOp(rValue); }
        MediumDecV2Base& operator+=(const unsigned __int64& rValue) { return IntAddOp(rValue); }
        MediumDecV2Base& operator+=(const signed __int64& rValue) { return IntAddOp(rValue); }
        MediumDecV2Base& operator+=(const signed __int16& rValue) { return IntAddOp(rValue); }
        MediumDecV2Base& operator+=(const signed __int8& rValue) { return IntAddOp(rValue); }
        MediumDecV2Base& operator+=(const unsigned __int16& rValue) { return IntAddOp(rValue); }
        MediumDecV2Base& operator+=(const unsigned __int8& rValue) { return IntAddOp(rValue); }
        ...
        /// <param name="rValue">The right side value.</param>
        /// <returns>MediumDecV2Base</returns>
        friend MediumDecV2Base operator+(MediumDecV2Base self, const MediumDecV2Base& rValue) { return self.AddOp(rValue); }
        friend MediumDecV2Base operator+(MediumDecV2Base self, const int& rValue) { return self.IntAddOp(rValue); }
        friend MediumDecV2Base operator+(MediumDecV2Base self, const unsigned int rValue) { return self.IntAddOp(rValue); }
        friend MediumDecV2Base operator+(MediumDecV2Base self, const signed long long rValue) { return self.IntAddOp(rValue); }
        friend MediumDecV2Base operator+(MediumDecV2Base self, const unsigned __int64 rValue) { return self.IntAddOp(rValue); }
        friend MediumDecV2Base operator+(MediumDecV2Base self, const __int16& rValue) { return self.IntAddOp(rValue); }
        friend MediumDecV2Base operator+(MediumDecV2Base self, const unsigned __int16& rValue) { return self.IntAddOp(rValue); }
        friend MediumDecV2Base operator+(MediumDecV2Base self, const signed __int8& rValue) { return self.IntAddOp(rValue); }
        friend MediumDecV2Base operator+(MediumDecV2Base self, const unsigned __int64& rValue) { return self.IntAddOp(rValue); }
        ...
        /// <param name="rValue">The right side value.</param>
        /// <returns>MediumDecV2Base</returns>
        MediumDecV2Base& operator-=(const MediumDecV2Base& rValue) { return SubOp(rValue); }
        ...
        /// <param name="rValue">The value.</param>
        /// <returns>MediumDecV2Base</returns>
        MediumDecV2Base& operator-=(const signed int& rValue) { return IntSubOp(rValue); }
        MediumDecV2Base& operator-=(const unsigned int& rValue) { return IntSubOp(rValue); }
        MediumDecV2Base& operator-=(const unsigned __int64& rValue) { return IntSubOp(rValue); }
        MediumDecV2Base& operator-=(const signed __int64& rValue) { return IntSubOp(rValue); }
        MediumDecV2Base& operator-=(const signed __int16& rValue) { return IntSubOp(rValue); }
        MediumDecV2Base& operator-=(const signed __int8& rValue) { return IntSubOp(rValue); }
        MediumDecV2Base& operator-=(const unsigned __int16& rValue) { return IntSubOp(rValue); }
        MediumDecV2Base& operator-=(const unsigned __int8& rValue) { return IntSubOp(rValue); }
        ...
        /// <param name="rValue">The right side value.</param>
        /// <returns>MediumDecV2Base</returns>
        friend MediumDecV2Base operator-(MediumDecV2Base self, const MediumDecV2Base& rValue) { return self.SubOp(rValue); }
        friend MediumDecV2Base operator-(MediumDecV2Base self, const int& rValue) { return self.IntSubOp(rValue); }
        friend MediumDecV2Base operator-(MediumDecV2Base self, const unsigned int rValue) { return self.IntSubOp(rValue); }
        friend MediumDecV2Base operator-(MediumDecV2Base self, const signed long long rValue) { return self.IntSubOp(rValue); }
        friend MediumDecV2Base operator-(MediumDecV2Base self, const unsigned __int64 rValue) { return self.IntSubOp(rValue); }
        friend MediumDecV2Base operator-(MediumDecV2Base self, const __int16& rValue) { return self.IntSubOp(rValue); }
        friend MediumDecV2Base operator-(MediumDecV2Base self, const unsigned __int16& rValue) { return self.IntSubOp(rValue); }
        friend MediumDecV2Base operator-(MediumDecV2Base self, const signed __int8& rValue) { return self.IntSubOp(rValue); }
        friend MediumDecV2Base operator-(MediumDecV2Base self, const unsigned __int64& rValue) { return self.IntSubOp(rValue); }
    ...
    #pragma region Other Operators
        ...
        /// <param name="self">The self.</param>
        /// <returns>MediumDecV2Base</returns>
        friend MediumDecV2Base& operator-(MediumDecV2Base& self)
        {
        ...
        /// </summary>
        /// <returns>MediumDecV2Base &</returns>
        MediumDecV2Base operator<<(const MediumDecV2Base& rValue)//MediumDecV2Base& operator<<(const MediumDecV2Base& rValue)
        {//Allowing negative shift operations based on formula instead of returning undefined
            MediumDecV2Base rightSideMultiplier = Two;
        ...
        /// </summary>
        /// <returns>MediumDecV2Base &</returns>
        MediumDecV2Base operator>>(const MediumDecV2Base& rValue)//operator<<(const MediumDecV2Base& rValue)
        {//Allowing negative shift operations based on formula instead of returning undefined
            MediumDecV2Base rightSideDivisor = Two;
    ...
    #pragma region Modulus Operations
        ...
        MediumDecV2Base Int32BasicRemOp(signed int& RValue) { return BasicIntRemOp(RValue); }
        MediumDecV2Base UInt32BasicRemOp(unsigned int& RValue) { return BasicIntRemOp(RValue); }
        MediumDecV2Base Int64BasicRemOp(signed long long& RValue) { return BasicIntRemOp(RValue); }
        MediumDecV2Base UInt64BasicRemOp(unsigned long long& RValue) { return BasicIntRemOp(RValue); }

        MediumDecV2Base Int32BasicRem(signed int RValue) { MediumDecV2Base self = *this; return BasicIntRemOp(RValue); }
        MediumDecV2Base UInt32BasicRem(unsigned int RValue) { MediumDecV2Base self = *this; return BasicIntRemOp(RValue); }
        MediumDecV2Base Int64BasicRem(signed long long RValue) { MediumDecV2Base self = *this; return BasicIntRemOp(RValue); }
        MediumDecV2Base UInt64BasicRem(unsigned long long RValue) { MediumDecV2Base self = *this; return BasicIntRemOp(RValue); }

        static MediumDecV2Base Int32BasicModulus(MediumDecV2Base self, signed int RValue) { return self.BasicIntRemOp(RValue); }
        static MediumDecV2Base UInt32BasicModulus(MediumDecV2Base self, unsigned int RValue) { return self.BasicIntRemOp(RValue); }
        static MediumDecV2Base Int64BasicModulus(MediumDecV2Base self, signed long long RValue) { return self.BasicIntRemOp(RValue); }
        ...
        MediumDecV2Base IntRemOp(const IntType& rValue)
        {
            ...
            MediumDecV2Base C = *this - divRes.MultipleByInt(rValue);
            return C;
        }
        ...
        /// </summary>
        /// <param name="RValue">The value.</param>
        MediumDecV2Base Int32RemOp(signed int& RValue) { return IntRemOp(RValue); }
        MediumDecV2Base UInt32RemOp(unsigned int& RValue) { return IntRemOp(RValue); }
        MediumDecV2Base Int64RemOp(signed long long& RValue) { return IntRemOp(RValue); }
        MediumDecV2Base UInt64RemOp(unsigned long long& RValue) { return IntRemOp(RValue); }

        MediumDecV2Base Int32Rem(signed int RValue) { MediumDecV2Base self = *this; return self.IntRemOp(RValue); }
        MediumDecV2Base UInt32Rem(unsigned int RValue) { MediumDecV2Base self = *this; return self.IntRemOp(RValue); }
        MediumDecV2Base Int64Rem(signed long long RValue) { MediumDecV2Base self = *this; return self.IntRemOp(RValue); }
        MediumDecV2Base UInt64Rem(unsigned long long RValue) { MediumDecV2Base self = *this; return self.IntRemOp(RValue); }

        static MediumDecV2Base Int32Modulus(MediumDecV2Base self, signed int RValue) { return self.IntRemOp(RValue); }
        static MediumDecV2Base UInt32Modulus(MediumDecV2Base self, unsigned int RValue) { return self.IntRemOp(RValue); }
        static MediumDecV2Base Int64Modulus(MediumDecV2Base self, signed long long RValue) { return self.IntRemOp(RValue); }
        static MediumDecV2Base UInt64Modulus(MediumDecV2Base self, unsigned long long RValue) { return self.IntRemOp(RValue); }
        ...
        //Will not work with non-decimaled format fractionals or mixed fractions
        //Modifies left side value with result
        MediumDecV2Base& BasicRemOp(const MediumDecV2Base& rValue)
        {
            if (rValue.DecimalHalf == 0)
            {
                if (DecimalHalf == 0)
            ...
            {
                MediumDecV2Base divRes = *this / rValue;
                MediumDecV2Base C = *this - rValue * divRes;
                IntValue = C.IntValue; DecimalHalf = C.DecimalHalf;
                ExtraRep = C.ExtraRep;
            }
        }

        MediumDecV2Base BasicRem(MediumDecV2Base rValue) { MediumDecV2Base self = *this; BasicRemOp(rValue); return self; }
        ...
        /// <returns>MediumDecV2Base</returns>
        MediumDecV2Base RemOp(const MediumDecV2Base& rValue)
        {
            MediumDecV2Base divRes = *this / rValue;
            MediumDecV2Base C = *this - rValue * divRes;
            return C;
        ...
        MediumDecV2Base Rem(const MediumDecV2Base& rValue) { MediumDecV2Base self = *this; return self.RemOp(rValue); }
        ...
        /// <returns>MediumDecV2Base&</returns>
        static MediumDecV2Base Modulus(MediumDecV2Base self, MediumDecV2Base Value) { return self.RemOp(Value); }

		void CatchAllRem(MediumDecV2Base& rValue, const RepType& LRep, const RepType& RRep)
		{
			ConvertToNormType(LRep);
			MediumDecV2Base convertedRVal = rValue.ConvertAsNormType(RRep);
		...
		void CatchAllRemV2(MediumDecV2Base& rValue, const RepType& SameRep)
		{
            ConvertToNormType(SameRep);
			MediumDecV2Base convertedRVal = rValue.ConvertAsNormType(SameRep);
			BasicRemOp(convertedRVal);
		...
		void CatchAllRemV3(MediumDecV2Base& rValue)
		{
			ConvertToNormTypeV2();
            MediumDecV2Base convertedRVal = rValue.ConvertAsNormTypeV2();
			BasicRemOp(convertedRVal);
        ...
        friend MediumDecV2Base operator%=(MediumDecV2Base& self, MediumDecV2Base Value) { return self.RemOp(Value); }
        friend MediumDecV2Base operator%=(MediumDecV2Base& self, int Value) { return self.Int32RemOp(Value); }
        friend MediumDecV2Base operator%=(MediumDecV2Base& self, unsigned int Value) { return self.UInt32RemOp(Value); }
        friend MediumDecV2Base operator%=(MediumDecV2Base& self, signed long long Value) { return self.Int64RemOp(Value); }
        friend MediumDecV2Base operator%=(MediumDecV2Base& self, unsigned __int64 Value) { return self.UInt64RemOp(Value); }
        ...
        /// </summary>
        /// <param name="RValue">The value.</param>
        AltNumModChecker<MediumDecV2Base> ModulusOp(signed int& RValue) { IntModulusOp(RValue); }
        AltNumModChecker<MediumDecV2Base> ModulusOp(unsigned int& RValue) { IntModulusOp(RValue); }
        AltNumModChecker<MediumDecV2Base> ModulusOp(signed long long& RValue) { IntModulusOp(RValue); }
        AltNumModChecker<MediumDecV2Base> ModulusOp(unsigned long long& RValue) { IntModulusOp(RValue); }

        static AltNumModChecker<MediumDecV2Base> ModulusOp(MediumDecV2Base& self, signed int& RValue) { self.IntModulusOp(RValue); }
        static AltNumModChecker<MediumDecV2Base> ModulusOp(MediumDecV2Base& self, unsigned int& RValue) { self.IntModulusOp(RValue); }
        static AltNumModChecker<MediumDecV2Base> ModulusOp(MediumDecV2Base& self, signed long long& RValue) { self.IntModulusOp(RValue); }
        static AltNumModChecker<MediumDecV2Base> ModulusOp(MediumDecV2Base& self, unsigned long long& RValue) { self.IntModulusOp(RValue); }


        static AltNumModChecker<MediumDecV2Base> ModulusOp(MediumDecV2BaseVariant RValue)
        {
            AltNumModChecker<MediumDecV2Base> Res;
        ...
        static AltNumModChecker<MediumDecV2Base> ModulusOp(MediumDecV2Base& self, MediumDecV2Base& RValue) { self.ModulusOp(RValue); }
        #endif
    ...
    #pragma region Bitwise Functions
        ...
        /// <summary>
        /// Bitwise XOR Operation Between MediumDecV2Base and Integer Value
        /// </summary>
        /// <param name="self">The self.</param>
        /// <param name="Value">The value.</param>
        /// <returns>MediumDecV2Base</returns>
        ...
        /// <summary>
        /// Bitwise Or Operation Between MediumDecV2Base and Integer Value
        /// </summary>
        /// <param name="self">The self.</param>
        /// <param name="Value">The value.</param>
        /// <returns>MediumDecV2Base</returns>
	...
	#pragma region Math Etc Functions
        ...
        /// <returns>MediumDecV2Base</returns>
        static MediumDecV2Base Abs(MediumDecV2Base tValue)
        {
            return tValue.Abs();
        }
        ...
        static MediumDecV2Base Floor(MediumDecV2Base Value, int precision=0)
        {
        ...
        static MediumDecV2Base Ceil(MediumDecV2Base Value) { return Value.CeilOp(); }
        ...
        /// <returns>MediumDecV2Base&</returns>
        template<typename MediumDecV2BaseVariant = MediumDecV2Base>
        static int FloorInt(MediumDecV2BaseVariant Value)
        {
        ...
        static int CeilInt(MediumDecV2Base Value) { return Value.CeilIntOp(); }

        /// <summary>
        /// Cuts off the decimal point from number
        /// </summary>
        /// <returns>MediumDecV2Base &</returns>
        MediumDecV2Base& Trunc()
        {
#if defined(AltNum_EnableInfinityRep)
            if (DecimalHalf == InfinityRep)
                return *this;
        ...
        /// <returns>MediumDecV2Base</returns>
        template<typename MediumDecV2BaseVariant = MediumDecV2Base>
        static MediumDecV2Base Trunc(MediumDecV2BaseVariant Value)
        {
            return Value.Trunc();
        }
	...
	#pragma region Pow and Sqrt Functions	
        ...
        /// </summary>
        static MediumDecV2Base BasicSqrt(MediumDecV2Base& value, int precision=7)
        {//Ignores Alternate representations use Sqrt instead to check based on RepType
            ...
            MediumDecV2Base number = value;
            MediumDecV2Base start = 0, end = number;
            MediumDecV2Base mid;
        ...
        /// Perform square root on this instance.(Code other than switch statement from https://www.geeksforgeeks.org/find-square-root-number-upto-given-precision-using-binary-search/)
        /// </summary>
		static MediumDecV2Base Sqrt(MediumDecV2Base value, int precision=7)
		{
		    value.ConvertToNormTypeV2();
...
public:
        ...
        /// <returns>MediumDecV2Base</returns>
        MediumDecV2Base NthRootOp(int& n, MediumDecV2Base& precision = MediumDecV2Base::JustAboveZero)
        {
            ...
            MediumDecV2Base xPre = One;
            xPre += (*this - One)/n;
            int nMinus1 = n - 1;

            // initializing difference between two 
            // roots by INT_MAX 
            MediumDecV2Base delX = MediumDecV2Base(2147483647, 0);

            //  xK denotes current value of x 
            MediumDecV2Base xK;
            MediumDecV2Base xPrePower;
            ...
            do
            {
                ...
                xK.IntDivOp(n);
                delX = MediumDecV2Base::Abs(xK - xPre);
                xPre = xK;
            } while (delX > precision);
            return xK;
        }

        MediumDecV2Base NthRoot(MediumDecV2Base value, int n, MediumDecV2Base precision = MediumDecV2Base::JustAboveZero) { return value.NthRootOp(n, precision); }
        ...
        MediumDecV2Base FractionalPow(int expNum, int expDenom);
        ...
        MediumDecV2Base FractionalPow(boost::rational<int>& Frac);

        MediumDecV2Base BasicPowOp(MediumDecV2Base& expValue);

        MediumDecV2Base BasicPow(MediumDecV2Base expValue) { MediumDecV2Base self = *this; return self.BasicPowOp(expValue); }

        /// <summary>
        /// Applies Power of operation
        /// </summary>
        /// <param name="expValue">The exponent value.</param>
        MediumDecV2Base PowOp(MediumDecV2Base& expValue);

        /// <summary>
        /// Applies Power of operation
        /// </summary>
        /// <param name="expValue">The exponent value.</param>
        MediumDecV2Base Pow(MediumDecV2Base expValue) { MediumDecV2Base self = *this; return self.PowOp(expValue); }
        ...
        /// <param name="expValue">The exponent value.</param>
        static MediumDecV2Base PowV2(MediumDecV2Base targetValue, MediumDecV2Base expValue) { return targetValue.PowOp(expValue); }
	...
	#pragma region Log Functions
        ...
        /// <returns></returns>
        static MediumDecV2Base NthRootV2(MediumDecV2Base targetValue, int n, MediumDecV2Base& Precision = MediumDecV2Base::FiveBillionth)
        {
            int nMinus1 = n - 1;
            MediumDecV2Base x[2] = { (MediumDecV2Base::One / n) * ((targetValue*nMinus1) + (targetValue / targetValue.IntPow(nMinus1))), targetValue };
            while (MediumDecV2Base::Abs(x[0] - x[1]) > Precision)
            {
                x[1] = x[0];
                x[0] = (MediumDecV2Base::One / n) * ((x[1]*nMinus1) + (targetValue / x[1].IntPow(nMinus1)));
            }
            return x[0];
        }
        ...
        /// <returns>MediumDecV2Base</returns>
        static MediumDecV2Base Exp(MediumDecV2Base& x)
        {
             ...
             * Args:
             *      - x: (MediumDecV2Base float) power of e to evaluate
             * Returns:
             *      - (MediumDecV2Base float) approximation of e^x in MediumDecV2Base precision
             */
             // Check that x is a valid input.
            assert(-709 <= x.IntValue && x.IntValue <= 709);
            // When x = 0 we already know e^x = 1.
            if (x.IsZero()) {
                return MediumDecV2Base::One;
            }
            // Normalize x to a non-negative value to take advantage of
            // reciprocal symmetry. But keep track of the original sign
            // in case we need to return the reciprocal of e^x later.
            MediumDecV2Base x0 = MediumDecV2Base::Abs(x);
            // First term of Taylor expansion of e^x at a = 0 is 1.
            // tn is the variable we we will return for e^x, and its
            // value at any time is the sum of all currently evaluated
            // Taylor terms thus far.
            MediumDecV2Base tn = MediumDecV2Base::One;
            // Chose a truncation point for the Taylor series using the
            // heuristic bound 12 * ceil(|x| e), then work down from there
            // using Horner's method.
            int n = MediumDecV2Base::CeilInt(x0 * MediumDecV2Base::E) * 12;
            for (int i = n; i > 0; --i) {
                tn = tn * (x0 / i) + MediumDecV2Base::One;
            }
            // If the original input x is less than 0, we want the reciprocal
            // of the e^x we calculated.
            if (x < 0) {
                tn = MediumDecV2Base::One / tn;
            }
            return tn;
        }
protected:
    static MediumDecV2Base LnRef_Part02(MediumDecV2Base& value)
    {	//Returns a positive value(http://www.netlib.org/cephes/qlibdoc.html#qlog)
        //Increasing iterations brings closer to accurate result(Larger numbers need more iterations to get accurate level of result)
        MediumDecV2Base TotalRes = (value - 1) / (value + 1);
        MediumDecV2Base LastPow = TotalRes;
        MediumDecV2Base WSquared = TotalRes * TotalRes;
        MediumDecV2Base AddRes;
        int WPow = 3;
        do
        {
            LastPow *= WSquared;
        ...
        } while (AddRes > MediumDecV2Base::JustAboveZero);
        return TotalRes * 2;
    }
public:
        /// <summary>
        ...
        /// </summary>
        /// <param name="value">The target value.</param>
        /// <returns>BlazesRusCode::MediumDecV2Base</returns>
        static MediumDecV2Base LnRef(MediumDecV2Base& value)
        {
            //if (value <= 0) {}else//Error if equal or less than 0
            if (value == MediumDecV2Base::One)
                return MediumDecV2Base::Zero;
            RepType repType = value.GetRepType();
            MediumDecV2Base ConvertedVal;
            switch (repType)
            {
#if defined(AltNum_EnableImaginaryNum)
            case RepType::INum:
            ...
            {//This section gives accurate answer(for values between 1 and 2)
                MediumDecV2Base threshold = MediumDecV2Base::FiveMillionth;
                MediumDecV2Base base = value - 1;        // Base of the numerator; exponent will be explicit
                int den = 2;              // Denominator of the nth term
                bool posSign = true;             // Used to swap the sign of each term
                MediumDecV2Base term = base;       // First term
                MediumDecV2Base prev;          // Previous sum
                MediumDecV2Base result = term;     // Kick it off
                ...
                do
                {
                    ...
                    if (posSign)
                        ...
                        result -= term / den;
                    ++den;
                } while (MediumDecV2Base::Abs(prev - result) > threshold);
        ...
        /// <param name="value">The target value.</param>
        /// <returns>BlazesRusCode::MediumDecV2Base</returns>
        static MediumDecV2Base LnRefV2(MediumDecV2Base& value)
        {
            //if (value <= 0) {}else//Error if equal or less than 0
            if (value == MediumDecV2Base::One)
                return MediumDecV2Base::Zero;
            ...
            {
                MediumDecV2Base W = (value - 1)/ (value + 1);
                MediumDecV2Base TotalRes = W;
                W.SwapNegativeStatus();
                MediumDecV2Base LastPow = W;
                MediumDecV2Base WSquared = W * W;
                int WPow = 3;
                MediumDecV2Base AddRes;
        ...
        /// <param name="value">The target value.</param>
        template<typename MediumDecV2BaseVariant = MediumDecV2Base>
        static MediumDecV2Base Ln(MediumDecV2BaseVariant value)
        {
            return LnRef(value);
        }

protected:
    static MediumDecV2Base Log10_Part02(MediumDecV2Base& value)
    {	//Returns a positive value(http://www.netlib.org/cephes/qlibdoc.html#qlog)
        MediumDecV2Base TotalRes = (value - 1) / (value + 1);
        MediumDecV2Base LastPow = TotalRes;
        MediumDecV2Base WSquared = TotalRes * TotalRes;
        ...
        return TotalRes * MediumDecV2Base::HalfLN10Mult;//Gives more accurate answer than attempting to divide by Ln10
    }
public:
        ...
        /// <returns>MediumDecV2Base</returns>
        template<typename MediumDecV2BaseVariant = MediumDecV2Base>
        static MediumDecV2Base Log10(MediumDecV2BaseVariant value)
        {
            if (value == MediumDecV2Base::One)
                return MediumDecV2Base::Zero;
            RepType repType = value.GetRepType();
            ...
            if (ConvertedVal.DecimalHalf == 0 && ConvertedVal.IntValue % 10 == 0)
            {
                for (int index = 1; index < 9; ++index)
                {
                    if (value == BlazesRusCode::VariableConversionFunctions::PowerOfTens[index])
                        return MediumDecV2Base(index, 0);
                }
                return MediumDecV2Base(9, 0);
            }
            if (ConvertedVal.IntValue>=0&&ConvertedVal.IntValue<2)//Threshold between 0 and 2 based on Taylor code series from https://stackoverflow.com/questions/26820871/c-program-which-calculates-ln-for-a-given-variable-x-without-using-any-ready-f
            {//This section gives accurate answer for values between 1 & 2
                MediumDecV2Base threshold = MediumDecV2Base::FiveBillionth;
                MediumDecV2Base base = value - 1;        // Base of the numerator; exponent will be explicit
                int den = 1;              // Denominator of the nth term
                bool posSign = true;             // Used to swap the sign of each term
                MediumDecV2Base term = base;       // First term
                MediumDecV2Base prev = 0;          // Previous sum
                MediumDecV2Base result = term;     // Kick it off
                ...
                return result*MediumDecV2Base::LN10Mult;// result/MediumDecV2Base::LN10;//Using Multiplication instead of division for speed improvement
            }
            else//Returns a positive value(http://www.netlib.org/cephes/qlibdoc.html#qlog)
            {
...
protected:
    ...
    static MediumDecV2Base Log10_IntPart02(ValueType& value)
    {	//Returns a positive value(http://www.netlib.org/cephes/qlibdoc.html#qlog)
        MediumDecV2Base TotalRes = MediumDecV2Base((value - 1), 0) / MediumDecV2Base((value + 1), 0);
        MediumDecV2Base LastPow = TotalRes;
        MediumDecV2Base WSquared = TotalRes * TotalRes;
        MediumDecV2Base AddRes;
        int WPow = 3;
...
public:
        ...
        /// <returns>MediumDecV2Base</returns>
        template<typename ValueType>
        static MediumDecV2Base IntegerLog10(ValueType value)
        {
            if (value == 1)
                return MediumDecV2Base::Zero;
            if (value % 10 == 0)
        ...
        /// <returns>MediumDecV2Base</returns>
        static MediumDecV2Base Log(MediumDecV2Base value, MediumDecV2Base baseVal)
        {
            RepType repType = value.GetRepType();
            MediumDecV2Base ConvertedVal;
            switch (repType)
            ...
            if (ConvertedVal == MediumDecV2Base::One)
                return MediumDecV2Base::Zero;
        ...
        /// <param name="BaseVal">The base of Log</param>
        /// <returns>MediumDecV2Base</returns>
        static MediumDecV2Base IntegerLog(MediumDecV2Base value, int baseVal)
        {
            RepType repType = value.GetRepType();
            MediumDecV2Base ConvertedVal;
            switch (repType)
            ...
            if (baseVal % 10 == 0)
            {
                for (int index = 1; index < 9; ++index)
                {
                    ...
                    {
                        baseTotalRes = MediumDecV2Base(index, 0);
                        break;
                    }
                }
                baseTotalRes = MediumDecV2Base(9, 0); lnMultLog = false;
            }
            else//Returns a positive baseVal(http://www.netlib.org/cephes/qlibdoc.html#qlog)
            {
                baseTotalRes = MediumDecV2Base((baseVal - 1), 0) / MediumDecV2Base((baseVal + 1), 0);
                MediumDecV2Base baseLastPow = baseTotalRes;
                MediumDecV2Base baseWSquared = baseTotalRes * baseTotalRes;
                MediumDecV2Base baseAddRes;
                int baseWPow = 3;
                do
                {
                ...
                } while (baseAddRes > MediumDecV2Base::JustAboveZero);
            }
            ...
            if (ConvertedVal.DecimalHalf == 0 && ConvertedVal.IntValue % 10 == 0)
            {
                ...
                {
                    if (value == BlazesRusCode::VariableConversionFunctions::PowerOfTens[index])
                        return lnMultLog ? MediumDecV2Base(index, 0) / (baseTotalRes * MediumDecV2Base::HalfLN10Mult): MediumDecV2Base(index, 0)/ baseTotalRes;
                }
                return lnMultLog? MediumDecV2Base(9, 0) / (baseTotalRes*MediumDecV2Base::HalfLN10Mult):MediumDecV2Base(9, 0)/baseTotalRes;
            }
            if (ConvertedVal.IntValue>=0&&ConvertedVal.IntValue<2)//Threshold between 0 and 2 based on Taylor code series from https://stackoverflow.com/questions/26820871/c-program-which-calculates-ln-for-a-given-variable-x-without-using-any-ready-f
            {//This section gives accurate answer for values between 1 & 2
                MediumDecV2Base threshold = MediumDecV2Base::FiveBillionth;
            ...
            else//Returns a positive value(http://www.netlib.org/cephes/qlibdoc.html#qlog)
            {
                ...
                return lnMultLog? TotalRes/baseTotalRes:(TotalRes * MediumDecV2Base::HalfLN10Mult)/ baseTotalRes;
            }
            //return Log10(Value) / Log10(BaseVal);
        }
    ...
    #pragma region Trigonomic Etc Functions
        ...
        /// <returns>MediumDecV2Base</returns>
        template<typename MediumDecV2BaseVariant = MediumDecV2Base>
        static MediumDecV2Base SinFromAngle(MediumDecV2BaseVariant Value)
        {
    #if defined(AltNum_EnableInfinityRep)
            ...
            if (Value == Zero) { return MediumDecV2Base::Zero; }
            ...
            {
                MediumDecV2Base NewValue = Zero;
                //Angle as Radian
                MediumDecV2Base Radius = Pi * Value / 180;
                for (int i = 0; i < 7; ++i)
        ...
        /// <returns></returns>
        template<typename MediumDecV2BaseVariant = MediumDecV2Base>
        static MediumDecV2Base CosFromAngle(MediumDecV2BaseVariant Value)
        {
#if defined(AltNum_EnableInfinityRep)
            if (Value.DecimalHalf == InfinityRep)
#if defined(AltNum_EnableNaN)
...
//Return undefined value between -1 and 1
        ...
        /// <returns>MediumDecV2Base</returns>
        static MediumDecV2Base BasicSinOperation(MediumDecV2Base& Value)
        {
            MediumDecV2Base SinValue = Zero;
            for (int i = 0; i < 7; ++i)
            {
       ...
       /// <summary>
        ...
        /// <returns>MediumDecV2Base</returns>
        template<typename MediumDecV2BaseVariant = MediumDecV2Base>
        static MediumDecV2Base Sin(MediumDecV2BaseVariant Value)
        {
/*
...
//Return undefined value between -1 and 1
        ...
        /// <param name="Value">The value in Radians.</param>
        /// <returns>MediumDecV2Base</returns>
        static MediumDecV2Base BasicCosOperation(MediumDecV2Base& Value)
        {
            MediumDecV2Base CosValue = Zero;
            for (int i = 0; i < 7; ++i)
            {
        ...
        /// <returns>MediumDecV2Base</returns>
        template<typename MediumDecV2BaseVariant = MediumDecV2Base>
        static MediumDecV2Base Cos(MediumDecV2BaseVariant Value)
        {
/*
...
*/
        ...
        /// <returns>MediumDecV2Base</returns>
        template<typename MediumDecV2BaseVariant = MediumDecV2Base>
        static MediumDecV2Base Tan(MediumDecV2BaseVariant Value)
        {
            MediumDecV2Base SinValue = Zero;
            MediumDecV2Base CosValue = Zero;
            for (int i = 0; i < 7; ++i)
        ...
        /// <returns>MediumDecV2Base</returns>
        template<typename MediumDecV2BaseVariant = MediumDecV2Base>
        static MediumDecV2Base TanFromAngle(MediumDecV2BaseVariant Value)
        {
            RepType repType = Value.GetRepType();
            switch (repType)
            {
            ...
            else if (Value.IntValue == 90 && Value.DecimalHalf == 0)
            {
                ...
                return Infinity;
#else
                return MediumDecV2Base::Maximum;//Positive Infinity
#endif
            }
            else if (Value.IntValue == 180 && Value.DecimalHalf == 0)
            {
            ...
            {
#if defined(AltNum_EnableInfinityRep)
                return MediumDecV2Base::NegativeInfinity;
#else
                return MediumDecV2Base::Minimum;//Negative Infinity
#endif
            }
            else
            {
        ...
        /// <returns>MediumDecV2Base</returns>
        template<typename MediumDecV2BaseVariant = MediumDecV2Base>
        static MediumDecV2Base ATan(MediumDecV2BaseVariant Value)
        {
            MediumDecV2Base SinValue = Zero;
            MediumDecV2Base CosValue = Zero;
            //Angle as Radian
        ...
        /// <returns>MediumDecV2Base</returns>
        static MediumDecV2Base ArcTan2(MediumDecV2Base y, MediumDecV2Base x)
        {
#if defined(AltNum_EnablePiRep)
    #if defined(AltNum_EnableDecimaledPiFractionals)
            MediumDecV2Base coeff_1 = MediumDecV2Base(1, 0, -4);
    #elif defined(AltNum_EnablePiFractional)
            MediumDecV2Base coeff_1 = MediumDecV2Base(1, 4, PiByDivisorRep);
    #else
            MediumDecV2Base coeff_1 = MediumDecV2Base(0, 250000000, PiRep);//Pi / 4;
    #endif
#else
            MediumDecV2Base coeff_1 = PiNum / 4;
#endif
#if defined(AltNum_EnablePiRep)
    #if defined(AltNum_EnableDecimaledPiFractionals)
            MediumDecV2Base coeff_2 = MediumDecV2Base(3, 0, -4);
    #elif defined(AltNum_EnablePiFractional)
            MediumDecV2Base coeff_2 = MediumDecV2Base(3, 4, PiByDivisorRep);
    #else
            MediumDecV2Base coeff_2 = MediumDecV2Base(0, 750000000, PiRep);//Pi / 4;
    #endif
#else
            MediumDecV2Base coeff_2 = PiNum * MediumDecV2Base(0, 750000000);
#endif
            MediumDecV2Base abs_y = MediumDecV2Base::Abs(y) + JustAboveZero;// kludge to prevent 0/0 condition
            MediumDecV2Base r;
            MediumDecV2Base angle;
            if (x >= 0)
            {
                r = (x - abs_y) / (x + abs_y);
    ...
    /// Reads the string.
    /// </summary>
    /// <param name="Value">The target value to convert into MediumDecV2Base</param>
    inline void MediumDecV2Base::ReadString(std::string Value)
    {
    ...
    /// <param name="Value">The value.</param>
    /// <returns>MediumDecV2Base</returns>
    inline MediumDecV2Base MediumDecV2Base::GetValueFromString(std::string Value)
    {
        MediumDecV2Base NewSelf = Zero;
        NewSelf.ReadString(Value);
        return NewSelf;
    }

	std::string MediumDecV2Base::BasicToStringOp()
	{
	...
	std::string MediumDecV2Base::BasicToFullStringOp()
	{
        std::string Value = IntHalfAsString();
        if (DecimalHalf != 0)
        {
    ...
    std::string MediumDecV2Base::ToFullString()
    {
        RepType repType = GetRepType();
        switch (repType)
        {
