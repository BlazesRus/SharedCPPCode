...
using RepType = BlazesRusCode::MediumDecV2Base::RepType;

void NormalOp(RepType& RRep, MediumDecV2Base& self, MediumDecV2Base& Value)
{
	switch (RRep)
	{
	...
	case RepType::PiFractional://  IntValue/DecimalHalf*Pi Representation
	{
		...
		self.BasicUnsignedDivOp(MediumDecV2Base::PiNum * Value.IntValue);//self.BasicUnsignedDivOp(PiNumMultByInt(Value.IntValue))
		break;
	}
		#endif
		...
		{
			self.BasicIntMultOp(Value.DecimalHalf);
			self.BasicUnsignedDivOp(MediumDecV2Base::ENum * Value.IntValue);
			break;
		}
		#endif
	...
	//Num/Yi = Num/Yi * i/i = Numi/-Y = -Numi/Y
		...
		{
			self.BasicUnsignedDivOp(Value);
			if (self.IntValue == MediumDecV2Base::NegativeRep)
				self.IntValue = 0;
			else
				self.IntValue = self.IntValue == 0 ? MediumDecV2Base::NegativeRep : -self.IntValue;
			self.ExtraRep = MediumDecV2Base::IRep;
			break;
		}
...
#if defined(AltNum_EnableFractionals)
void NumByDivOp(RepType& RRep, MediumDecV2Base& self, MediumDecV2Base& Value)
{
}
#endif

#if defined(AltNum_EnablePiRep)
void PiNumOp(RepType& RRep, MediumDecV2Base& self, MediumDecV2Base& Value)
{
}

	#if defined(AltNum_EnablePiPowers)
void PiPowerOp(RepType& RRep, MediumDecV2Base& self, MediumDecV2Base& Value)
{
}
	#endif
	
	#if defined(AltNum_EnableDecimaledPiFractionals)
void PiNumByDivOp(RepType& RRep, MediumDecV2Base& self, MediumDecV2Base& Value)
{
}
	#elif defined(AltNum_EnablePiFractional)
void PiFractionalOp(RepType& RRep, MediumDecV2Base& self, MediumDecV2Base& Value)
{
}
	#endif
#endif
...
void ENumOp(RepType& RRep, MediumDecV2Base& self, MediumDecV2Base& Value)
{
}

	#if defined(AltNum_EnableDecimaledEFractionals)
void ENumByDivOp(RepType& RRep, MediumDecV2Base& self, MediumDecV2Base& Value)
{
}
	#elif defined(AltNum_EnableEFractional)
void EFractionalOp(RepType& RRep, MediumDecV2Base& self, MediumDecV2Base& Value)
{
}
	#endif
#endif
...
void ApproachingBottomOp(RepType& RRep, MediumDecV2Base& self, MediumDecV2Base& Value)
{
}

	#if !defined(AltNum_DisableApproachingTop)
void ApproachingTopOp(RepType& RRep, MediumDecV2Base& self, MediumDecV2Base& Value)
{
}
	#endif
	#if defined(AltNum_EnableApproachingDivided)
void ApproachingMidLeftOp(RepType& RRep, MediumDecV2Base& self, MediumDecV2Base& Value)
{
}

		#if !defined(AltNum_DisableApproachingTop)
void ApproachingMidRightOp(RepType& RRep, MediumDecV2Base& self, MediumDecV2Base& Value)
{
}
		#endif
	#endif
...
#if defined(AltNum_EnableImaginaryNum)
void INumOp(RepType& RRep, MediumDecV2Base& self, MediumDecV2Base& Value)
{
}

	#if defined(AltNum_EnableDecimaledIFractionals)
void INumByDivOp(RepType& RRep, MediumDecV2Base& self, MediumDecV2Base& Value)
{
}
	#elif defined(AltNum_EnableIFractional)
void IFractionalOp(RepType& RRep, MediumDecV2Base& self, MediumDecV2Base& Value)
{
}
	#endif
#endif
...
void ApproachingImaginaryBottomOp(RepType& RRep, MediumDecV2Base& self, MediumDecV2Base& Value)
{
}

	#if !defined(AltNum_DisableApproachingTop)
void ApproachingImaginaryTopOp(RepType& RRep, MediumDecV2Base& self, MediumDecV2Base& Value)
{
}
	#endif
	#if defined(AltNum_EnableApproachingDivided)
void ApproachingImaginaryMidLeftOp(RepType& RRep, MediumDecV2Base& self, MediumDecV2Base& Value)
{
}

	    #if !defined(AltNum_DisableApproachingTop)
void ApproachingImaginaryMidRightOp(RepType& RRep, MediumDecV2Base& self, MediumDecV2Base& Value)
{
}
	    #endif
    #endif
...
void MixedFracOp(RepType& RRep, MediumDecV2Base& self, MediumDecV2Base& Value)
{
}
	#if defined(AltNum_EnableMixedPiFractional)
void MixedPiOp(RepType& RRep, MediumDecV2Base& self, MediumDecV2Base& Value)
{
}
	#elif defined(AltNum_EnableMixedEFractional)
void MixedEOp(RepType& RRep, MediumDecV2Base& self, MediumDecV2Base& Value)
{
}
	#elif defined(AltNum_EnableMixedIFractional)
void MixedIOp(RepType& RRep, MediumDecV2Base& self, MediumDecV2Base& Value)
{
}
	#endif
#endif
...
#if defined(AltNum_EnableImaginaryNum)
void LRepImaginaryOverridePt2(RepType& LRep, RepType& RRep, MediumDecV2Base& self, MediumDecV2Base& Value)
{
	switch (RRep)
	{
/*
	...
	case RepType::ApproachingImaginaryBottom:
		if (Value.IntValue == 0)
		{
			...
			if (self.IntValue < 0)//NegativeValue / 0.0..1 = Negative Infinity
				...
				self.IntValue = 1;
			self.DecimalHalf = MediumDecV2Base::InfinityRep;
			self.ExtraRep = 0;
		#else
...
inline void BlazesRusCode::MediumDecV2Base::RepToRepDivOp(RepType& LRep, RepType& RRep, MediumDecV2Base& self, MediumDecV2Base Value)
{
    //LRep Overrides
	...
	#endif
		default:
			throw MediumDecV2Base::RepTypeAsString(LRep)+" RepType division with"+MediumDecV2Base::RepTypeAsString(RRep)+"not supported yet";
			break;
	}
}