...
*/
	...
	#if defined(FlaggedNum_ExtraRepIsActive)
        #if !defined(FlaggedNum_UseBitset)
        FlaggedDec(signed int intVal = 0, signed int decVal = 0, unsigned char flagsActive = 0, signed int extraVal = 0)
        #else
        FlaggedDec(signed int intVal = 0, signed int decVal = 0, std::bitset<6> flagsActive = {}, signed int extraVal = 0)
        #endif
    #else
        #if !defined(FlaggedNum_UseBitset)
