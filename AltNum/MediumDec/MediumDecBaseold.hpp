...
public:
		...
		auto Log10Of()
		{
            ...
            {//This section gives accurate answer for values between 1 & 2
                ...
                return result*TenthLN10;// result/MediumDecBase::LN10;//Using Multiplication instead of division for speed improvement
            }
...
protected:
    ...
    {	//Returns a positive value(http://www.netlib.org/cephes/qlibdoc.html#qlog)
        ...
        return TotalRes * MediumDecBase::FifthLN10;//Gives more accurate answer than attempting to divide by Ln10
    }
        ...
        auto LogOf_Section02(const bool& lnMultLog, const auto& baseTotalRes, const auto& threshold)
        {
            ...
            if (DecimalHalf == 0 && IntHalf % 10 == 0)
            {
                if(lnMultLog)
                {
                    ...
                    {
                        if (value == BlazesRusCode::VariableConversionFunctions::PowerOfTens[index])
                            return MediumDecBase(index, 0) / (baseTotalRes * FifthLN10);
                    }
                    return MediumDecBase(9, 0) / (baseTotalRes*FifthLN10);
                }
                else
                {
                    for (int index = 1; index < 9; ++index)
