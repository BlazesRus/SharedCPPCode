...
namespace BlazesRusCode
{
  ...
  //Used to store value range between -16777215.99 and 16777215.99
  class DLL_API SmallDec
  {
  public:
  ...
  #pragma region class_constructors
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="SmallDec"/> class.
    /// </summary>
    ...
    //Fix for C2440 error during static template class
    static SmallDec InitializeV2(const signed int& intVal, const PartialInt& decVal = PartialInt::Zero)
    {
    ...
    void SetValue(const SmallDec& rValue)
    {
  ...
  #pragma region Negative_Status
    ...
    SmallDec operator-() const
    { SmallDec self = *this; self.SwapNegativeStatus(); return self; }
...
public:
    ...
    /// </summary>
    /// <returns>SmallDec</returns>
    static SmallDec OneValue();

    /// <summary>
    /// Returns the value at one
    /// </summary>
    /// <returns>SmallDec</returns>
    static SmallDec TwoValue();

    /// <summary>
    /// Returns the value at negative one
    /// </summary>
    /// <returns>SmallDec</returns>
    static SmallDec NegativeOneValue();

    /// <summary>
    /// Returns the value at 0.5
    /// </summary>
    /// <returns>SmallDec</returns>
    static SmallDec Point5Value();
    ...
    static SmallDec NegativePointFiveValue();

    static SmallDec PointOneValue();
    ...
    /// </summary>
    /// <returns>SmallDec</returns>
    static const SmallDec Zero;

    /// <summary>
    /// Returns the value at one
    /// </summary>
    /// <returns>SmallDec</returns>
    static const SmallDec One;

    /// <summary>
    /// Returns the value at two
    /// </summary>
    /// <returns>SmallDec</returns>
    static const SmallDec Two;

    /// <summary>
    /// Returns the value at 0.5
    /// </summary>
    /// <returns>SmallDec</returns>
    static const SmallDec PointFive;
  ...
  #pragma region String Commands
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="SmallDec"/> class from string literal
    /// </summary>
    /// <param name="strVal">The value.</param>
    SmallDec(const char* strVal);

    /// <summary>
    /// Initializes a new instance of the <see cref="SmallDec"/> class.
    /// </summary>
    /// <param name="tValue">The value.</param>
    SmallDec(const std::string& Value);
...
public:
  ...
  #pragma region ConvertFromOtherTypes
    ...
    /// </summary>
    /// <param name="tValue">The value.</param>
    SmallDec(const float& tValue){ this->SetFloatVal(tValue); }

    /// <summary>
    /// Initializes a new instance of the <see cref="SmallDec"/> class.
    /// </summary>
    /// <param name="tValue">The value.</param>
    SmallDec(const double& tValue){ this->SetDoubleVal(tValue); }

    /// <summary>
    /// Initializes a new instance of the <see cref="SmallDec"/> class.
    /// </summary>
    /// <param name="tValue">The value.</param>
    SmallDec(const long double& tValue){ this->SetDecimalVal(tValue); }

  #endif

    SmallDec(const unsigned __int64& Value){ this->SetUIntVal(Value); }
    SmallDec(const signed __int64& Value){ this->SetIntVal(Value); }
    SmallDec(const unsigned char& Value){ this->SetUIntVal(Value); }
    SmallDec(const signed char& Value){ this->SetIntVal(Value); }
    SmallDec(const unsigned short& Value){ this->SetUIntVal(Value); }
    SmallDec(const signed short& Value){ this->SetIntVal(Value); }
    SmallDec(const unsigned int& Value){ this->SetUIntVal(Value); }

    /// <summary>
    /// Initializes a new instance of the <see cref="SmallDec"/> class.
    /// </summary>
    /// <param name="tValue">The value.</param>
    SmallDec(const bool& Value){ this->SetBoolVal(Value); }
  ...
  #pragma region ConvertToOtherTypes
    ...
    /// <summary>
    /// SmallDec Variant to float explicit conversion
    /// </summary>
    /// <returns>The result of the operator.</returns>
    float toFloat() const;

    /// <summary>
    /// SmallDec Variant to double explicit conversion
    /// </summary>
    /// <returns>The result of the operator.</returns>
    double toDouble() const;

    /// <summary>
    /// SmallDec Variant to long double explicit conversion
    /// </summary>
    /// <returns>The result of the operator.</returns>
    ...
    /// <summary>
    /// SmallDec Variant to int explicit conversion
    /// </summary>
    /// <returns>The result of the operator.</returns>
    signed int toInt() const { return IsNegative():-((int)IntHalf)? IntHalf; }

    /// <summary>
    /// SmallDec Variant to int explicit conversion
    /// </summary>
    /// <returns>The result of the operator.</returns>
    unsigned int toUInt() const { return IsNegative()()?0:IntHalf; }
    ...
    /// <summary>
    /// SmallDec Variant to decimal explicit conversion
    /// </summary>
    /// <returns>The result of the operator.</returns>
    ...
    /// <summary>
    /// SmallDec Variant to uint explicit conversion
    /// </summary>
    /// <returns>The result of the operator.</returns>
    explicit operator unsigned int() { return toUInt(); }

    /// <summary>
    /// SmallDec Variant to int64 explicit conversion
    /// </summary>
    /// <returns>The result of the operator.</returns>
    explicit operator signed __int64() { return toInt(); }

    /// <summary>
    /// SmallDec Variant to ubyte explicit conversion
    /// </summary>
    /// <returns>The result of the operator.</returns>
    explicit operator unsigned char() { return toUInt(); }

    /// <summary>
    /// SmallDec Variant to byte explicit conversion
    /// </summary>
    /// <returns>The result of the operator.</returns>
    explicit operator signed char() { return toInt(); }

    /// <summary>
    /// SmallDec Variant to ushort explicit conversion
    /// </summary>
    /// <returns>The result of the operator.</returns>
    explicit operator unsigned short() { return toUInt(); }

    /// <summary>
    /// SmallDec Variant to short explicit conversion
    /// </summary>
    /// <returns>The result of the operator.</returns>
    explicit operator signed short() { return toInt(); }

    /// <summary>
    /// SmallDec Variant to bool explicit conversion
    /// </summary>
    /// <returns>The result of the operator.</returns>
...
protected:
    ...
    std::strong_ordering BasicComparison(const SmallDec& that) const
    {
...
public:
    ...
    std::strong_ordering operator<=>(const SmallDec& that) const
    ...
    bool operator==(const SmallDec& that) const
    {
...
protected:
    ...
    /// <summary>
    /// Basic division operation between SmallDec Variant and unsigned Integer value
    ...
    /// <summary>
    /// Basic division operation between SmallDec Variant and Integer value
    /// that ignores special representation status
    /// (Doesn't modify owner object)
    /// </summary>
    /// <param name="rValue">The right side value</param>
...
public:
    ...
    SmallDec& UIntDivOperation(const unsigned int& rValue) { return UIntDivOperationV1(rValue); }
    SmallDec& IntDivOperation(const signed int& rValue) { return IntDivOperationV1(rValue); }
    SmallDec& UInt64DivOperation(const unsigned __int64& rValue) { return UIntDivOperationV1(rValue); }
    SmallDec& Int64DivOperation(const signed __int64& rValue) { return IntDivOperationV1(rValue); }
    SmallDec& UInt8DivOperation(const unsigned char& rValue) { return UIntDivOperationV1(rValue); }
    SmallDec& Int8DivOperation(const signed char& rValue) { return IntDivOperationV1(rValue); }
    SmallDec& UInt16DivOperation(const unsigned short& rValue) { return UIntDivOperationV1(rValue); }
    SmallDec& Int16DivOperation(const signed short& rValue) { return IntDivOperationV1(rValue); }

    const SmallDec DivideByUInt(const unsigned int& rValue) { return DivideByUIntV1(rValue); }
    const SmallDec DivideByInt(const signed int& rValue) { return DivideByIntV1(rValue); }
    const SmallDec DivideByUInt64(const unsigned __int64& rValue) { return DivideByUIntV1(rValue); }
    const SmallDec DivideByInt64(const signed __int64& rValue) { return DivideByIntV1(rValue); }

    const SmallDec UnsignedDivideByInt(const signed int& rValue) { return DivideByUIntV1(rValue); }
    const SmallDec UnsignedDivideByInt64(const signed __int64& rValue) { return DivideByUIntV1(rValue); }

    const SmallDec DivideByUInt8(const unsigned char& rValue) { return DivideByUIntV1(rValue); }
    const SmallDec DivideByInt8(const signed char& rValue) { return DivideByIntV1(rValue); }
    const SmallDec DivideByUInt16(const unsigned short& rValue) { return DivideByUIntV1(rValue); }
    const SmallDec DivideByInt16(const signed short& rValue) { return DivideByIntV1(rValue); }
...
public:
    ...
    bool UnsignedPartialDivOp(const SmallDec& rValue){ return UnsignedPartialDivOpV1(rValue); }
    ...
    /// </summary>
    /// <param name="rValue.">The right side value</param>
    void UnsignedDivOp(const SmallDec& rValue){ UnsignedDivOpV1(rValue); }
    ...
    /// </summary>
    /// <param name="rValue.">The right side tValue</param>
    void DivOp(const SmallDec& rValue){ DivOpV1(rValue); }
    ...
    /// </summary>
    /// <param name="rValue.">The right side tValue</param>
    SmallDec& UnsignedDivOperation(const SmallDec& rValue)
    ...
    /// </summary>
    /// <param name="rValue.">The right side tValue</param>
    SmallDec& DivOperation(const SmallDec& rValue)
    ...
    /// </summary>
    /// <param name="rValue.">The right side tValue</param>
    SmallDec DivideByUnsigned(const SmallDec& rValue) const
    { SmallDec lValue = *this; return lValue.UnsignedDivOperation(rValue); }
    ...
    /// </summary>
    /// <param name="rValue.">The right side tValue</param>
    SmallDec DivideBy(const SmallDec& rValue) const
    { SmallDec lValue = *this; return lValue.DivOperation(rValue); }
  ...
  #pragma region Other Division Operations
    ...
    SmallDec DividedByTwo() const;

    //Return copy of result divided by four
    SmallDec DividedByFour() const;
    ...
    /// <param name="rValue">The right side value.</param>
    /// <returns>SmallDec</returns>
    friend SmallDec& operator/=(SmallDec& lValue, const SmallDec& rValue) { return lValue.DivOperation(rValue); }

    /// <summary>
    /// *= operation between SmallDec variant and Integer rValue.
    /// </summary>
    /// <param name="lValue">The left side value</param>
    /// <param name="rValue">The right side value.</param>
    /// <returns>SmallDec</returns>
    friend SmallDec& operator/=(SmallDec& lValue, const signed int& rValue) { return lValue.IntDivOperation(rValue); }
    friend SmallDec& operator/=(SmallDec& lValue, const signed __int64& rValue) { return lValue.Int64DivOperation(rValue); }
    friend SmallDec& operator/=(SmallDec& lValue, const unsigned int& rValue) { return lValue.UIntDivOperation(rValue); }
    friend SmallDec& operator/=(SmallDec& lValue, const unsigned __int64& rValue) { return lValue.UInt64DivOperation(rValue); }

    friend SmallDec& operator/=(SmallDec& lValue, const signed char& rValue) { return lValue.Int8DivOperation(rValue); }
    friend SmallDec& operator/=(SmallDec& lValue, const signed short& rValue) { return lValue.Int16DivOperation(rValue); }
    friend SmallDec& operator/=(SmallDec& lValue, const unsigned char& rValue) { return lValue.UInt8DivOperation(rValue); }
    friend SmallDec& operator/=(SmallDec& lValue, const unsigned short& rValue) { return lValue.UInt16DivOperation(rValue); }
    ...
    /// <param name="rValue">The right side value.</param>
    /// <returns>SmallDec</returns>
    friend SmallDec operator/(SmallDec lValue, const SmallDec& rValue) { return lValue.DivideBy(rValue); }

    /// <summary>
    /// Division operation between SmallDec variant and Integer rValue.
    /// </summary>
    /// <param name="lValue">The left side value</param>
    /// <param name="rValue">The right side value.</param>
    /// <returns>SmallDec</returns>
    ...
    friend SmallDec operator/(const signed int& lValue, const SmallDec& rValue) { return ((SmallDec)lValue).DivideBy(rValue); }
    friend SmallDec operator/(const signed __int64& lValue, const SmallDec& rValue) { return ((SmallDec)lValue).DivideBy(rValue); }
    friend SmallDec operator/(const unsigned int& lValue, const SmallDec& rValue) { return ((SmallDec)lValue).DivideBy(rValue); }
    friend SmallDec operator/(const unsigned __int64& lValue, const SmallDec& rValue) { return ((SmallDec)lValue).DivideBy(rValue); }

    friend SmallDec operator/(const signed char& lValue, const SmallDec& rValue) { return ((SmallDec)lValue).DivideBy(rValue); }
    friend SmallDec operator/(const signed short& lValue, const SmallDec& rValue) { return ((SmallDec)lValue).DivideBy(rValue); }
    friend SmallDec operator/(const unsigned char& lValue, const SmallDec& rValue) { return ((SmallDec)lValue).DivideBy(rValue); }
    friend SmallDec operator/(const unsigned short& lValue, const SmallDec& rValue) { return ((SmallDec)lValue).DivideBy(rValue); }
...
protected:
    ...
    /// <summary>
    /// Basic multiplication operation between SmallDec variant and unsigned Integer value
    /// that ignores special representation status
    /// (Doesn't modify owner object)
    /// </summary>
    /// <param name="rValue">The right side value</param>
    template<IntegerType IntType=unsigned int>
    const SmallDec MultiplyByUIntV1(const IntType& rValue)
    { auto self = *this; return self.UIntMultOperationV1(rValue); }

    /// <summary>
    /// Basic multiplication operation between SmallDec variant and Integer value
    /// that ignores special representation status
    /// (Doesn't modify owner object)
    /// </summary>
    /// <param name="rValue">The right side value</param>
    template<IntegerType IntType=signed int>
    const SmallDec MultiplyByIntV1(const IntType& rValue)
    { auto self = *this; return self.IntMultOperationV1(rValue); }

    template<SmallDecVariant VariantType=SmallDec, IntegerType IntType=unsigned int>
...
public:
    ...
    SmallDec& UIntMultOperation(const unsigned int& rValue) { return UIntMultOperationV1(rValue); }
    SmallDec& IntMultOperation(const signed int& rValue) { return IntMultOperationV1(rValue); }
    SmallDec& UInt64MultOperation(const unsigned __int64& rValue) { return UIntMultOperationV1(rValue); }
    SmallDec& Int64MultOperation(const signed __int64& rValue) { return IntMultOperationV1(rValue); }
    SmallDec& UInt8MultOperation(const unsigned char& rValue) { return UIntMultOperationV1(rValue); }
    SmallDec& Int8MultOperation(const signed char& rValue) { return IntMultOperationV1(rValue); }
    SmallDec& UInt16MultOperation(const unsigned short& rValue) { return UIntMultOperationV1(rValue); }
    SmallDec& Int16MultOperation(const signed short& rValue) { return IntMultOperationV1(rValue); }

    const SmallDec MultiplyByUInt(const unsigned int& rValue) { return MultiplyByUIntV1(rValue); }
    const SmallDec MultiplyByInt(const signed int& rValue) { return MultiplyByIntV1(rValue); }
    const SmallDec MultiplyByUInt64(const unsigned __int64& rValue) { return MultiplyByUIntV1(rValue); }
    const SmallDec MultiplyByInt64(const signed __int64& rValue) { return MultiplyByIntV1(rValue); }

    const SmallDec UnsignedMultiplyByInt(const signed int& rValue) { return MultiplyByUIntV1(rValue); }
    const SmallDec UnsignedMultiplyByInt64(const signed __int64& rValue) { return MultiplyByUIntV1(rValue); }

    const SmallDec MultiplyByUInt8(const unsigned char& rValue) { return MultiplyByUIntV1(rValue); }
    const SmallDec MultiplyByInt8(const signed char& rValue) { return MultiplyByIntV1(rValue); }
    const SmallDec MultiplyByUInt16(const unsigned short& rValue) { return MultiplyByUIntV1(rValue); }
    const SmallDec MultiplyByInt16(const signed short& rValue) { return MultiplyByIntV1(rValue); }
...
protected:
    ...
    /// <summary>
    /// Basic multiplication operation that ignores special decimal status with unsigned SmallDec
    /// (Modifies owner object)
    /// </summary>
    /// <param name="rValue.">The right side tValue</param>
    template<SmallDecVariant VariantType=SmallDec>
...
public:
    ...
    /// </summary>
    /// <param name="rValue.">The right side tValue</param>
    void UnsignedMultOp(const SmallDec& rValue){ UnsignedMultOpV1(rValue); }

    void MultOp(const SmallDec& rValue){ MultOpV1(rValue); }
    ...
    /// </summary>
    /// <param name="rValue.">The right side tValue</param>
    SmallDec& UnsignedMultOperation(const SmallDec& rValue)
    ...
    /// </summary>
    /// <param name="rValue.">The right side tValue</param>
    SmallDec& MultOperation(const SmallDec& rValue)
    ...
    /// </summary>
    /// <param name="rValue.">The right side tValue</param>
    SmallDec MultiplyByUnsigned(const SmallDec& rValue) const
    { SmallDec lValue = *this; return lValue.UnsignedMultOperation(rValue); }
    ...
    /// </summary>
    /// <param name="rValue.">The right side tValue</param>
    SmallDec MultiplyBy(const SmallDec& rValue) const
    { SmallDec lValue = *this; return lValue.MultOperation(rValue); }
  ...
  #pragma region Other multiplication operations
    ...
    //Return copy of result divided by two
    SmallDec MultipliedByTwo() const;

    //Return copy of result divided by four
    SmallDec MultipliedByFour() const;
    ...
    /// <param name="rValue">The right side value.</param>
    /// <returns>SmallDec</returns>
    friend SmallDec& operator*=(SmallDec& lValue, const SmallDec& rValue) { return lValue.MultOperation(rValue); }
    ...
    /// <param name="lValue">The left side value</param>
    /// <param name="rValue">The right side value.</param>
    friend SmallDec& operator*=(SmallDec& lValue, const signed int& rValue) { return lValue.IntMultOperation(rValue); }
    friend SmallDec& operator*=(SmallDec& lValue, const signed __int64& rValue) { return lValue.Int64MultOperation(rValue); }
    friend SmallDec& operator*=(SmallDec& lValue, const unsigned int& rValue) { return lValue.UIntMultOperation(rValue); }
    friend SmallDec& operator*=(SmallDec& lValue, const unsigned __int64& rValue) { return lValue.UInt64MultOperation(rValue); }

    friend SmallDec& operator*=(SmallDec& lValue, const signed char& rValue) { return lValue.Int8MultOperation(rValue); }
    friend SmallDec& operator*=(SmallDec& lValue, const signed short& rValue) { return lValue.Int16MultOperation(rValue); }
    friend SmallDec& operator*=(SmallDec& lValue, const unsigned char& rValue) { return lValue.UInt8MultOperation(rValue); }
    friend SmallDec& operator*=(SmallDec& lValue, const unsigned short& rValue) { return lValue.UInt16MultOperation(rValue); }
    ...
    /// <summary>
    /// Multiplication operation between SmallDec variant and Integer rValue.
    /// </summary>
    ...
    friend SmallDec operator*(signed int lValue, SmallDec rValue)  { return rValue.IntMultOperation(lValue); }
    friend SmallDec operator*(signed __int64 lValue, SmallDec& rValue)  { return rValue.Int64MultOperation(lValue); }
    friend SmallDec operator*(unsigned int lValue, SmallDec& rValue)  { return rValue.UIntMultOperation(lValue); }
    friend SmallDec operator*(unsigned __int64 lValue, SmallDec& rValue)  { return rValue.UInt64MultOperation(lValue); }

    friend SmallDec operator*(signed char lValue, SmallDec& rValue)  { return rValue.Int8MultOperation(lValue); }
    friend SmallDec operator*(signed short lValue, SmallDec& rValue)  { return rValue.Int16MultOperation(lValue); }
    friend SmallDec operator*(unsigned char lValue, SmallDec& rValue)  { return rValue.UInt8MultOperation(lValue); }
    friend SmallDec operator*(unsigned short lValue, SmallDec& rValue)  { return rValue.UInt16MultOperation(lValue); }
...
protected:
    ...
    /// <summary>
    /// Basic addition operation between SmallDec Variant and unsigned Integer value
    /// that ignores special representation status
    /// (Modifies owner object)
    /// </summary>
    /// <param name="rValue">The right side value</param>
    ...
    /// <summary>
    /// Basic addition operation between SmallDec Variant and Integer value
    /// that ignores special representation status
    /// (Modifies owner object)
    /// </summary>
    /// <param name="rValue">The right side value</param>
    ...
    /// <summary>
    ///  addition operation between SmallDec variant and unsigned Integer value
    /// that ignores special representation status
    /// (Doesn't modify owner object)
    /// </summary>
    /// <param name="rValue">The right side value</param>
...
public:
    ...
    /// <summary>
    /// Basic addition operation between SmallDec Variant and unsigned MirroredInt
    /// that ignores special representation status
    /// (Modifies owner object)
    /// </summary>
    /// <param name="rValue">The right side value</param>
    ...
    /// <summary>
    /// Basic addition operation between SmallDec Variant and MirroredInt
    /// that ignores special representation status
    /// (Modifies owner object)
    /// </summary>
    /// <param name="rValue">The right side value</param>
    ...
    SmallDec& UInt8AddOperation(const unsigned char& rValue) { return UIntAddOperationV1(rValue); }
    SmallDec& UInt16AddOperation(const unsigned short& rValue) { return UIntAddOperationV1(rValue); }
    SmallDec& UIntAddOperation(const unsigned int& rValue);
    SmallDec& UInt64AddOperation(const unsigned __int64& rValue) { return UIntAddOperationV1(rValue); }

    SmallDec UnsignedAddByInt(const signed int& rValue) { return AddByUIntV1(rValue); }
    SmallDec UnsignedAddByInt64(const signed __int64& rValue) { return AddByUIntV1(rValue); }

    SmallDec AddByUInt8(const unsigned char& rValue) { return AddByUIntV1(rValue); }
    SmallDec AddByUInt16(const unsigned short& rValue) { return AddByUIntV1(rValue); }
    SmallDec AddByUInt(const unsigned int& rValue) { return AddByUIntV1(rValue); }
    SmallDec AddByUInt64(const unsigned __int64& rValue) { return AddByUIntV1(rValue); }
    ...
    SmallDec& Int8AddOperation(const signed char& rValue) { return IntAddOperationV1(rValue); }
    SmallDec& Int16AddOperation(const signed short& rValue) { return IntAddOperationV1(rValue); }
    SmallDec& IntAddOperation(const signed int& rValue) { return IntAddOperationV1(rValue); }
    SmallDec& Int64AddOperation(const signed __int64& rValue) { return IntAddOperationV1(rValue); }

    SmallDec AddByInt8(const signed char rValue) { return AddByIntV1(rValue); }
    SmallDec AddByInt16(const signed short& rValue) { return AddByIntV1(rValue); }
    SmallDec AddByInt(const signed int& rValue) { return AddByIntV1(rValue); }
    SmallDec AddByInt64(const signed __int64& rValue) { return AddByIntV1(rValue); }
...
protected:
    ...
    /// <summary>
    /// Basic Subtraction operation between SmallDec Variant and unsigned Integer value
    /// that ignores special representation status
    /// (Modifies owner object)
    /// </summary>
    /// <param name="rValue">The right side value</param>
    ...
    /// <summary>
    /// Basic Subtraction operation between SmallDec Variant and Integer value
    /// that ignores special representation status
    /// (Modifies owner object)
    /// </summary>
    /// <param name="rValue">The right side value</param>
...
public:
    ...
    /// <summary>
    /// Basic Subtraction operation between SmallDec Variant and unsigned MirroredInt
    /// that ignores special representation status
    /// (Modifies owner object)
    /// </summary>
    /// <param name="rValue">The right side value</param>
    ...
    /// <summary>
    /// Basic Subtraction operation between SmallDec Variant and MirroredInt
    /// that ignores special representation status
    /// (Modifies owner object)
    /// </summary>
    /// <param name="rValue">The right side value</param>
    ...
    SmallDec& UInt8SubOperation(const unsigned char& rValue) { return UIntSubOperationV1(rValue); }
    SmallDec& UInt16SubOperation(const unsigned short& rValue) { return UIntSubOperationV1(rValue); }
    SmallDec& UIntSubOperation(const unsigned int& rValue);
    SmallDec& UInt64SubOperation(const unsigned __int64& rValue) { return UIntSubOperationV1(rValue); }

    SmallDec UnsignedSubtractByInt(const signed int& rValue) { return SubtractByUIntV1(rValue); }
    SmallDec UnsignedSubtractByInt64(const signed __int64& rValue) { return SubtractByUIntV1(rValue); }

    SmallDec SubtractByUInt8(const unsigned char& rValue) { return SubtractByUIntV1(rValue); }
    SmallDec SubtractByUInt16(const unsigned short& rValue) { return SubtractByUIntV1(rValue); }
    SmallDec SubtractByUInt(const unsigned int& rValue) { return SubtractByUIntV1(rValue); }
    SmallDec SubtractByUInt64(const unsigned __int64& rValue) { return SubtractByUIntV1(rValue); }

    SmallDec& Int8SubOperation(const signed char& rValue) { return IntSubOperationV1(rValue); }
    SmallDec& Int16SubOperation(const signed short& rValue) { return IntSubOperationV1(rValue); }
    SmallDec& IntSubOperation(const signed int& rValue) { return IntSubOperationV1(rValue); }
    SmallDec& Int64SubOperation(const signed __int64& rValue) { return IntSubOperationV1(rValue); }

    SmallDec SubtractByInt8(const signed char rValue) { return SubtractByIntV1(rValue); }
    SmallDec SubtractByInt16(const signed short& rValue) { return SubtractByIntV1(rValue); }
    SmallDec SubtractByInt(const signed int& rValue) { return SubtractByIntV1(rValue); }
    SmallDec SubtractByInt64(const signed __int64& rValue) { return SubtractByIntV1(rValue); }
...
public:
    ...
    /// </summary>
    /// <param name="rValue.">The right side rValue</param>
    void UnsignedAddOp(const SmallDec& rValue){ UnsignedAddOpV1(rValue); }
    ...
    /// </summary>
    /// <param name="rValue.">The right side rValue</param>
    void AddOp(const SmallDec& rValue){ AddOpV1(rValue); }
    ...
    /// </summary>
    /// <param name="rValue.">The right side rValue</param>
    void UnsignedSubOp(const SmallDec& rValue){ UnsignedSubOpV1(rValue); }
    ...
    /// </summary>
    /// <param name="rValue.">The right side rValue</param>
    void SubOp(const SmallDec& rValue){ SubOpV1(rValue); }

    //Basic addition operation
    SmallDec& UnsignedAddOperation(const SmallDec& rValue)
    { UnsignedAddOp(rValue); return *this; }

    //Basic addition operation
    SmallDec& AddOperation(const SmallDec& rValue)
    ...
    /// </summary>
    /// <param name="rValue.">The right side tValue</param>
    SmallDec AddByUnsigned(const SmallDec& rValue)
    { SmallDec lValue = *this; return lValue.UnsignedAddOperation(rValue); } const
    ...
    /// </summary>
    /// <param name="rValue.">The right side tValue</param>
    SmallDec AddBy(const SmallDec& rValue)
    { SmallDec lValue = *this; return lValue.AddOperation(rValue); } const

    //Basic subtraction operation
    SmallDec& UnsignedSubOperation(const SmallDec& rValue)
    { UnsignedSubOp(rValue); return *this; }

    //Basic subtraction operation
    SmallDec& SubOperation(const SmallDec& rValue)
    ...
    /// </summary>
    /// <param name="rValue.">The right side tValue</param>
    SmallDec SubtractByUnsigned(const SmallDec& rValue)
    { SmallDec lValue = *this; return lValue.UnsignedSubOperation(rValue); } const
    ...
    /// </summary>
    /// <param name="rValue.">The right side tValue</param>
    SmallDec SubtractBy(const SmallDec& rValue)
    { SmallDec lValue = *this; return lValue.SubOperation(rValue); } const
  ...
  #pragma region Other addition operations
    ...
    /// <param name="rValue">The right side value.</param>
    /// <returns>SmallDec</returns>
    friend SmallDec& operator+=(SmallDec& lValue, const SmallDec& rValue) { return lValue.AddOperation(rValue); }
    ...
    /// <param name="lValue">The left side value</param>
    /// <param name="rValue">The right side value.</param>
    friend SmallDec& operator+=(SmallDec& lValue, const signed int& rValue) { return lValue.IntAddOperation(rValue); }
    friend SmallDec& operator+=(SmallDec& lValue, const signed __int64& rValue) { return lValue.Int64AddOperation(rValue); }
    friend SmallDec& operator+=(SmallDec& lValue, const unsigned int& rValue) { return lValue.UIntAddOperation(rValue); }
    friend SmallDec& operator+=(SmallDec& lValue, const unsigned __int64& rValue) { return lValue.UInt64AddOperation(rValue); }

    friend SmallDec& operator+=(SmallDec& lValue, const signed char& rValue) { return lValue.Int8AddOperation(rValue); }
    friend SmallDec& operator+=(SmallDec& lValue, const signed short& rValue) { return lValue.Int16AddOperation(rValue); }
    friend SmallDec& operator+=(SmallDec& lValue, const unsigned char& rValue) { return lValue.UInt8AddOperation(rValue); }
    friend SmallDec& operator+=(SmallDec& lValue, const unsigned short& rValue) { return lValue.UInt16AddOperation(rValue); }
    ...
    /// <summary>
    /// Addition operation between SmallDec variant and Integer rValue.
    /// </summary>
    /// <param name="self">The left side value</param>
    /// <param name="rValue">The right side value.</param>
    friend SmallDec operator+(SmallDec lValue, const signed int& rValue) { return lValue.IntAddOperation(rValue); }
    ...
    friend SmallDec operator+(const signed int& lValue, SmallDec rValue)  { return rValue.IntAddOperation(lValue); }
    friend SmallDec operator+(const signed __int64& lValue, SmallDec rValue)  { return rValue.Int64AddOperation(lValue); }
    friend SmallDec operator+(const unsigned int& lValue, SmallDec rValue)  { return rValue.UIntAddOperation(lValue); }
    friend SmallDec operator+(const unsigned __int64& lValue, SmallDec rValue)  { return rValue.UInt64AddOperation(lValue); }

    friend SmallDec operator+(const signed char& lValue, SmallDec rValue)  { return rValue.Int8AddOperation(lValue); }
    friend SmallDec operator+(const signed short& lValue, SmallDec rValue)  { return rValue.Int16AddOperation(lValue); }
    friend SmallDec operator+(const unsigned char& lValue, SmallDec rValue)  { return rValue.UInt8AddOperation(lValue); }
    friend SmallDec operator+(const unsigned short& lValue, SmallDec rValue)  { return rValue.UInt16AddOperation(lValue); }
  ...
  #pragma region Other subtraction operations
    ...
    /// <param name="rValue">The right side value.</param>
    /// <returns>SmallDec</returns>
    friend SmallDec& operator-=(SmallDec& lValue, const SmallDec& rValue) { return lValue.SubOperation(rValue); }
    ...
    /// <param name="rValue">The right side value.</param>
    /// <returns>SmallDec</returns>
    friend SmallDec& operator-=(SmallDec& lValue, const signed int& rValue) { return lValue.IntSubOperation(rValue); }
    friend SmallDec& operator-=(SmallDec& lValue, const signed __int64& rValue) { return lValue.Int64SubOperation(rValue); }
    friend SmallDec& operator-=(SmallDec& lValue, const unsigned int& rValue) { return lValue.UIntSubOperation(rValue); }
    friend SmallDec& operator-=(SmallDec& lValue, const unsigned __int64& rValue) { return lValue.UInt64SubOperation(rValue); }

    friend SmallDec& operator-=(SmallDec& lValue, const signed char& rValue) { return lValue.Int8SubOperation(rValue); }
    friend SmallDec& operator-=(SmallDec& lValue, const signed short& rValue) { return lValue.Int16SubOperation(rValue); }
    friend SmallDec& operator-=(SmallDec& lValue, const unsigned char& rValue) { return lValue.UInt8SubOperation(rValue); }
    friend SmallDec& operator-=(SmallDec& lValue, const unsigned short& rValue) { return lValue.UInt16SubOperation(rValue); }
    ...
    /// <summary>
    /// Subtraction operation between SmallDec variant and Integer rValue.
    /// </summary>
    /// <param name="lValue">The left side value</param>
    /// <param name="rValue">The right side value.</param>
    /// <returns>SmallDec</returns>
    ...
    friend SmallDec operator-(const signed int& lValue, const SmallDec& rValue) { return ((SmallDec)lValue).SubtractBy(rValue); }
    friend SmallDec operator-(const signed __int64& lValue, const SmallDec& rValue) { return ((SmallDec)lValue).SubtractBy(rValue); }
    friend SmallDec operator-(const unsigned int& lValue, const SmallDec& rValue) { return ((SmallDec)lValue).SubtractBy(rValue); }
    friend SmallDec operator-(const unsigned __int64& lValue, const SmallDec& rValue) { return ((SmallDec)lValue).SubtractBy(rValue); }

    friend SmallDec operator-(const signed char& lValue, const SmallDec& rValue) { return ((SmallDec)lValue).SubtractBy(rValue); }
    friend SmallDec operator-(const signed short& lValue, const SmallDec& rValue) { return ((SmallDec)lValue).SubtractBy(rValue); }
    friend SmallDec operator-(const unsigned char& lValue, const SmallDec& rValue) { return ((SmallDec)lValue).SubtractBy(rValue); }
    friend SmallDec operator-(const unsigned short& lValue, const SmallDec& rValue) { return ((SmallDec)lValue).SubtractBy(rValue); }
  ...
  public:
    ...
    void UnsignedModulusOp(const SmallDec& rValue){ UnsignedModulusOpV1(rValue); }

    void ModulusOp(const SmallDec& rValue){ ModulusOpV1(rValue); }

    SmallDec& UnsignedModulusOperation(const SmallDec& rValue){
      UnsignedModulusOp(rValue); return *this;
    }

    SmallDec& ModulusOperation(const SmallDec& rValue){
      ModulusOp(rValue); return *this;
    }

    friend SmallDec& operator%=(SmallDec& lValue, const SmallDec& rValue) { return lValue.ModulusOperation(rValue); }
    friend SmallDec& operator%=(SmallDec& lValue, const signed int& rValue) { lValue.IntModulusOp(rValue); return lValue; }
    friend SmallDec& operator%=(SmallDec& lValue, const unsigned int& rValue) { lValue.UIntModulusOp(rValue); return lValue; }
    friend SmallDec& operator%=(SmallDec& lValue, const unsigned __int64& rValue) { lValue.UInt64ModulusOp(rValue); return lValue;}
    friend SmallDec& operator%=(SmallDec& lValue, const signed __int64& rValue) { lValue.Int64ModulusOp(rValue); return lValue;}
  ...
  /*
    ...
    /// <summary>
    /// Bitwise XOR Operation Between SmallDec and Integer tValue
    /// </summary>
    /// <param name="self">The self.</param>
    /// <param name="tValue">The value.</param>
    /// <returns>SmallDec</returns>
    template<IntegerType IntType=signed int>
    friend SmallDec operator^(SmallDec self, IntType tValue)
    {
    ...
    /// <summary>
    /// Bitwise Or Operation Between SmallDec and Integer tValue
    /// </summary>
    /// <param name="self">The self.</param>
    /// <param name="tValue">The value.</param>
    /// <returns>SmallDec</returns>
  ...
  */
  ...
  #pragma region Floating Operator Overrides
    ...
    friend SmallDec operator+(const SmallDec& self, const float& tValue) { return self + (SmallDec)tValue; }
    friend SmallDec operator-(const SmallDec& self, const float& tValue) { return self - (SmallDec)tValue; }
    friend SmallDec operator*(const SmallDec& self, const float& tValue) { return self * (SmallDec)tValue; }
    friend SmallDec operator/(const SmallDec& self, const float& tValue) { return self / (SmallDec)tValue; }

    friend SmallDec operator+(const float& tValue, const SmallDec& self) { return (SmallDec)tValue + self; }
    friend SmallDec operator-(const float& tValue, const SmallDec& self) { return (SmallDec)tValue - self; }
    friend SmallDec operator*(const float& tValue, const SmallDec& self) { return (SmallDec)tValue * self; }
    friend SmallDec operator/(const float& tValue, const SmallDec& self) { return (SmallDec)tValue / self; }

    friend SmallDec operator+(const SmallDec& self, const double& tValue) { return self + (SmallDec)tValue; }
    friend SmallDec operator-(const SmallDec& self, const double& tValue) { return self - (SmallDec)tValue; }
    friend SmallDec operator*(const SmallDec& self, const double& tValue) { return self * (SmallDec)tValue; }
    friend SmallDec operator/(const SmallDec& self, const double& tValue) { return self / (SmallDec)tValue; }

    friend SmallDec operator+(const SmallDec& self, const long double& tValue) { return self + (SmallDec)tValue; }
    friend SmallDec operator-(const SmallDec& self, const long double& tValue) { return self - (SmallDec)tValue; }
    friend SmallDec operator*(const SmallDec& self, const long double& tValue) { return self * (SmallDec)tValue; }
    friend SmallDec operator/(const SmallDec& self, const long double& tValue) { return self / (SmallDec)tValue; }

    friend SmallDec operator+(const long double& tValue, const SmallDec& self) { return (SmallDec)tValue + self; }
    friend SmallDec operator-(const long double& tValue, const SmallDec& self) { return (SmallDec)tValue - self; }
    friend SmallDec operator*(const long double& tValue, const SmallDec& self) { return (SmallDec)tValue * self; }
    friend SmallDec operator/(const long double& tValue, const SmallDec& self) { return (SmallDec)tValue / self; }
  ...
  */
  ...
  #pragma region Other Operators
    ...
    /// <summary>
    /// SmallDec Variant++ Operator
    /// </summary>
    /// <returns>SmallDec</returns>
    SmallDec operator ++(int)
    {
      SmallDec tmp(*this);
      ++* this;
      return tmp;
...
public:
    ...
    /// Forces Number into non-negative
    /// </summary>
    static SmallDec Abs(const SmallDec& tValue);

    /// <summary>
    /// Returns a copy of the number converted into non-negative version
    /// </summary>
    SmallDec AbsOf() const { return Abs(*this); }
...
public:
    ...
    static SmallDec Ceil(const SmallDec& tValue) { return CeilV1<SmallDec>(tValue); }

    ///<summary>
    /// Returns the smallest integer that is greater than or equal to tValue (Rounds up to integer value).
    ///</summary>
    /// <param name="tValue">Variable to apply method on</param>
    SmallDec CeilOf() const { return Ceil(*this); }
    ...
    /// </summary>
    /// <returns>SmallDec&</returns>
    static signed int FloorInt(const SmallDec& tValue) { return tValue.FloorIntOf(); }
    ...
    /// </summary>
    /// <returns>SmallDec&</returns>
    static signed int CeilInt(const SmallDec& tValue) { return tValue.CeilIntOf(); }

    static SmallDec Trunc(const SmallDec& tValue);
...
public:
    ...
    /// Perform square root on this instance.(Code other than switch statement from https://www.geeksforgeeks.org/find-square-root-number-upto-given-precision-using-binary-search/)
    /// </summary>
    static SmallDec Sqrt(const auto& value, const int& precision = 7);

    /// <summary>
    /// Perform square root on this instance.(Code other than switch statement from https://www.geeksforgeeks.org/find-square-root-number-upto-given-precision-using-binary-search/)
    /// </summary>
    SmallDec SqrtOf(const int& precision = 7) const;
...
protected:
    ...
    /// <param name="tValue">The target value to perform power of operation.</param>
    /// <param name="expValue">The exponent value.</param>
    template<SmallDecVariant VariantType=SmallDec, IntegerType IntType=signed int>
...
public:
    ...
    /// <param name="tValue">The target value to perform power of operation.</param>
    /// <param name="expValue">The exponent value.</param>
    static SmallDec UIntPow(const SmallDec& tValue, const unsigned int& expValue)
    { return IntPowV1<SmallDec>(tValue, expValue); }
    static SmallDec UInt64Pow(const SmallDec& tValue, const unsigned __int64& expValue)
    { return UIntPowV1<SmallDec>(tValue, expValue); }
    ...
    /// <param name="tValue">The target value to perform power of operation.</param>
    /// <param name="expValue">The exponent value.</param>
    static SmallDec IntPow(const SmallDec& tValue, const signed int& expValue)
    { return IntPowV1<SmallDec>(tValue, expValue); }
    static SmallDec Int64Pow(const SmallDec& tValue, const signed __int64& expValue)
    { return IntPowV1<SmallDec>(tValue, expValue); }

    SmallDec UnsignedNegIntPower(const SmallDec& tValue, const unsigned int& expValue)
    { return UnsignedNegIntPowerV1<SmallDec>(tValue, expValue); }
    ...
    /// </summary>
    /// <param name="expValue">The exponent value.</param>
    SmallDec UIntPowOf(const unsigned int& expValue) const
    { return UIntPow(*this, expValue); }
    SmallDec UInt64PowOf(const unsigned __int64& expValue) const
    ...
    /// </summary>
    /// <param name="expValue">The exponent value.</param>
    SmallDec IntPowOf(const signed int& expValue) const
...
public:
    ...
    static SmallDec UnsignedNthRoot(const SmallDec& tValue, const unsigned int& n, const SmallDec& precision = SmallDec::JustAboveZero);
    ...
    /// <param name="nValue">The nth root degree value.</param>
    /// <param name="precision">Precision level (smaller = more precise)</param>
    static SmallDec NthRoot(const SmallDec& tValue, const unsigned int& n, const SmallDec& precision = SmallDec::JustAboveZero)
    {
      return NthRootV1<SmallDec>(tValue, n, precision);
    }

    SmallDec NthRootOf(const unsigned int& n, const SmallDec& precision = SmallDec::JustAboveZero) const;

    static SmallDec AlternativeNthRoot(const SmallDec& tValue, const unsigned int& n, const SmallDec& precision = SmallDec::FiveBillionth);
...
protected:
    ...
    static VariantType FractionalPowV1(const auto& value, const boost::rational<unsigned int>& Frac)
    {
      ...
      VariantType CalcVal = SmallDecVariant::NthRoot(targetVal, Frac.denominator());
      return CalcVal;
    }
    ...
    const VariantType FractionalPowV2(const VariantType& value, const signed int& expNum, const unsigned int& expDenom)
    {
      ...
      auto CalcVal = SmallDecVariant::NthRoot(targetVal, expDenom);
      return CalcVal;
    }
    ...
    {
      boost::rational<unsigned int> Frac = boost::rational<unsigned int>(expValue.DecimalHalf, SmallDecVariant::DecimalOverflow);
...
public:
    ...
    /// (Doesn't modify owner object)
    /// </summary>
    SmallDec UnsignedPowOf(const auto& expValue)
    ...
    /// (Doesn't modify owner object)
    /// </summary>
    SmallDec PowOf(const auto& expValue)
...
protected:
    ...
    /// </summary>
    /// <param name="value">The target value.</param>
    /// <returns>SmallDec variant</returns>
    template<SmallDecVariant VariantType = SmallDec>
...
public:
    ...
    /// <param name="x">The value to apply the exponential function to.</param>
    /// <returns>SmallDec</returns>
    static SmallDec Exp(const SmallDec& x) { return ExpV1(x); }
    ...
    /// <param name="value">The target value.</param>
    /// <returns>SmallDec</returns>
    static SmallDec Ln(const SmallDec& value)
    { return LnV1(value); }
    ...
    /// <param name="tValue">The value.</param>
    /// <returns>SmallDec</returns>
    static SmallDec Log10(const SmallDec& value)
    ...
    /// <param name="tValue">The value.</param>
    /// <returns>SmallDec</returns>
    static SmallDec Log10OfInt(const unsigned int& value)
    ...
    /// <param name="baseVal">The base of Log</param>
    /// <returns>SmallDec Variant</returns>
    static SmallDec Log(const SmallDec& value, const SmallDec& baseVal)
    ...
    /// <param name="BaseVal">The base of Log</param>
    /// <returns>SmallDec</returns>
    static SmallDec LogOfInt(const SmallDec& value, const unsigned int& baseVal)
      ...
      if(lValue.DecimalHalf==0)
      {
        switch(lValue.IntHalf.Value)
        {
          ...
          default:
            ...
            return SmallDec::SinV1<VariantType>(Radius);
            break;
        }
      }
      else
      ...
      if(lValue.DecimalHalf==0)
      {
        switch(lValue.IntHalf.Value)
        {
          ...
          default:
            //Angle as Radian
            VariantType Radius = PiNum * lValue / 180;
            return SmallDec::CosV1<VariantType>(Radius);
            break;
        }
      }
      else
      ...
      if(lValue.DecimalHalf==0)
      {
        switch(lValue.IntHalf.Value)
        {
          ...
          case 270://1.5 Pi Radians
            ...
            break;
          default:
            return SmallDec::TanV1<VariantType>(PiNum * lValue / 180);
            break;
        }
      }
      else
...
public:
    ...
    /// </summary>
    /// <param name="tValue">The value in Radians.</param>
    static SmallDec Sin(const SmallDec& tValue)
    { return SinV1<SmallDec>(tValue); }
    ...
    static SmallDec Cos(const SmallDec& tValue)
    { return CosV1<SmallDec>(tValue); }
    ...
    /// </summary>
    /// <param name="tValue">The tValue in Radians.</param>
    static SmallDec Tan(const SmallDec& tValue)
    { return TanV1<SmallDec>(tValue); }
    ...
    /// </summary>
    /// <param name="tValue">The tValue in Radians.</param>
    static SmallDec ATan(const SmallDec& tValue)
    { return ATanV1<SmallDec>(tValue); }
    ...
    /// </summary>
    /// <param name="tValue">The target value in degrees to perform operation on.</param>
    static SmallDec SinFromAngle(const SmallDec& tValue)
    { return SinFromAngleV1<SmallDec>(tValue); }
    ...
    /// </summary>
    /// <param name="tValue">The target value in degrees to perform operation on.</param>
    static SmallDec CosFromAngle(const SmallDec& tValue)
    { return CosFromAngleV1<SmallDec>(tValue); }
    ...
    /// </summary>
    /// <param name="tValue">The target value in degrees to perform operation on.</param>
    static SmallDec TanFromAngle(const SmallDec& tValue)
    { return TanFromAngleV1<SmallDec>(tValue); }
    ...
    /// <param name="y">The y.</param>
    /// <param name="X">The x.</param>
    static SmallDec ArcTan2(const SmallDec& y, const SmallDec& x)
    { return ArcTan2V1<SmallDec>(y, x); }
