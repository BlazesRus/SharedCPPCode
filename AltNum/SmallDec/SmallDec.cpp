...
{
	return SmallDec(MirroredInt::Maximum, 999999999);
}

SmallDec BlazesRusCode::SmallDec::MaximumValue()
{
	return SmallDec(MirroredInt::Minimum, 999999999);
}

SmallDec BlazesRusCode::SmallDec::NegativePointFiveValue()
{
	return SmallDec(MirroredInt::NegativeZero, 500000000);
}

SmallDec BlazesRusCode::SmallDec::PointOneValue()
{
	return SmallDec(0, 100000000);
}

#pragma endregion ValueDefines

#pragma region ValueDefine Source
const MirroredInt SmallDec::NegativeRep = MirroredInt::NegativeZero;
...
void BlazesRusCode::SmallDec::SetAsValues(const MirroredInt& intVal, const PartialInt& decVal)
{
	IntHalf = 0; DecimalHalf = 0;
}
