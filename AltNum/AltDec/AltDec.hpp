...
public:
        ...
        AltDec(const MirroredInt& intVal=MirroredInt::Zero, const PartialInt& decVal = PartialInt::Zero, const FlaggedInt& extraVal = InitialExtraRep)
        {
            IntHalf = intVal;
            DecimalHalf = decVal;
            ExtraRep = extraVal;
        ...
        AltDec& operator=(const MediumDec& rhs)
        {
            // Check for self-assignment
            if (this == &rhs)      // Same object?
                return *this;        // Yes, so skip assignment, and just return *this.
        ...
        AltDec& operator=(const MediumDecV2& rhs)
        {
            // Check for self-assignment
            if (this == &rhs)      // Same object?
                return *this;        // Yes, so skip assignment, and just return *this.
...
public:
        constexpr auto SetPiVal = SetPiValV1<AltDec>;
...
public:
        constexpr auto SetEVal = SetEValV1<AltDec>;
...
public:
        constexpr auto SetIVal = SetIValV0<AltDec>;
...
public:
        ...
        constexpr auto GetValueFromString = MediumDec::GetValueFromString<AltDec>;
        ...
        /// </summary>
        /// <param name="Value">The value.</param>
        AltDec(const long double& Value)
        {
...
public:
    ...
    #pragma region NormalRep Integer Subtraction Operations
        ...
        /// <returns>AltDec&</returns>
        template<IntegerType IntType=signed int>
        constexpr auto BasicIntSubOp = MediumDec::BasicIntSubOp<AltDec>;
...
public:
        ...
        friend AltDec operator/(const UInt64& lValue, const AltDec& rValue) { return ((AltDec)lValue).DivideBy(rValue); }
        ...
        friend AltDec& operator/=(AltDec& self, const Int64& Value) { return self.Int64DivOp(Value); }
        friend AltDec& operator/=(AltDec& self, const unsigned int& Value) { return self.UIntDivOp(Value); }
        friend AltDec& operator/=(AltDec& self, const UInt64& Value) { return self.UInt64DivOp(Value); }
...
public:
        ...
        /// <param name="Value">The right side value.</param>
        /// <returns>MediumDecVariant</returns>
        friend AltDec operator*(const AltDec& self, const AltDec& Value) { return self.MultBy(Value); }
        ...
        /// <param name="Value">The right side value.</param>
        /// <returns>MediumDecVariant</returns>
        friend AltDec operator*(const AltDec& self, const signed int& Value) { return self.MultByInt(Value); }
        ...
        friend AltDec operator*(const UInt64& lValue, const AltDec& rValue) { return rValue.MultByUInt64(lValue); }

        friend AltDec operator*(const AltDec& self, const signed char& Value) { return self.MultByInt8(Value); }
        friend AltDec operator*(const AltDec& self, const signed short& Value) { return self.MultByInt16(Value); }
        friend AltDec operator*(const AltDec& self, const unsigned char& Value) { return self.MultByUInt8(Value); }
        friend AltDec operator*(const AltDec& self, const unsigned short& Value) { return self.MultByUInt16(Value); }

        friend AltDec operator*(const signed char& lValue, const AltDec& rValue) { return rValue.MultByInt8(lValue); }
        friend AltDec operator*(const signed short& lValue, const AltDec& rValue) { return rValue.MultByInt16(lValue); }
        friend AltDec operator*(const unsigned char& lValue, const AltDec& rValue) { return rValue.MultByUInt8(lValue); }
        friend AltDec operator*(const unsigned short& lValue, const AltDec& rValue) { return rValue.MultByUInt16(lValue); }
        ...
        friend AltDec& operator*=(AltDec& self, const Int64& Value) { return self.Int64MultOp(Value); }
        friend AltDec& operator*=(AltDec& self, const unsigned int& Value) { return self.UIntMultOp(Value); }
        friend AltDec& operator*=(AltDec& self, const UInt64& Value) { return self.UInt64MultOp(Value); }
...
public:
        ...
        friend AltDec operator+(const UInt64& lValue, const AltDec& rValue) { return rValue.AddByUInt64(lValue); }
        ...
        /// <param name="Value">The right side value.</param>
        /// <returns>MediumDecVariant</returns>
        friend AltDec& operator+=(MediumDecV2& self, const signed int& Value) { return self.IntAddOp(Value); }
        friend AltDec& operator+=(MediumDec& self, const Int64& Value) { return self.Int64AddOp(Value); }
        friend AltDec& operator+=(MediumDec& self, const unsigned int& Value) { return self.UIntAddOp(Value); }
        friend AltDec& operator+=(MediumDec& self, const UInt64& Value) { return self.UInt64AddOp(Value); }

        friend AltDec& operator+=(MediumDec& self, const signed char& Value) { return self.Int8AddOp(Value); }
        friend AltDec& operator+=(MediumDec& self, const signed short& Value) { return self.Int16AddOp(Value); }
        friend AltDec& operator+=(MediumDec& self, const unsigned char& Value) { return self.UInt8AddOp(Value); }
        friend AltDec& operator+=(MediumDec& self, const unsigned short& Value) { return self.UInt16AddOp(Value); }
...
public:
        ...
        friend AltDec operator-(const UInt64& lValue, const AltDec& rValue) { return ((AltDec)lValue).SubtractBy(rValue); }
        ...
        friend AltDec& operator-=(AltDec& self, const Int64& Value) { return self.Int64SubOp(Value); }
        friend AltDec& operator-=(AltDec& self, const unsigned int& Value) { return self.UIntSubOp(Value); }
        friend AltDec& operator-=(AltDec& self, const UInt64& Value) { return self.UInt64SubOp(Value); }
