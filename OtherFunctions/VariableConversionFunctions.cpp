...
unsigned int VariableConversionFunctions::PowerOfTens[10] = { 1, 10, 100, 1000, 10000, 100000, 1000000, 10000000, 100000000, 1000000000 };
unsigned __int64 VariableConversionFunctions::PowerOfTens64Bit[19] = { 1, 10, 100, 1000, 10000, 100000, 1000000, 10000000, 100000000, 1000000000, 10000000000, 100000000000, 1000000000000, 10000000000000, 100000000000000, 1000000000000000, 10000000000000000, 100000000000000000, 1000000000000000000 };
...
std::string VariableConversionFunctions::Int64ToStringConversion(size_t IntegerHalf)
{
	if (IntegerHalf == 0)
		return "0";
	...
	for (int i = NumberOfPlaces(IntegerHalf); i >= 0; --i)
	{
		...
		{
			PowResult = VariableConversionFunctions::PowerOfTens64Bit[i];//IntPow(10, i);
			CurrentDigit = floor(IntegerHalf / PowResult);
